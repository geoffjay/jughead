// oauth.go is a vendored copy of services/github/oauth.go, trimmed to the
// authorization-code web flow helpers the provider uses. It references the
// trimmed Client in this package (NewClient) rather than the full
