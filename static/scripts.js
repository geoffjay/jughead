...
})({"5ma9C":[function(require,module,exports) {
...
},{"htmx.org":"dcidz","hyperscript.org":"Qyk3J"}],"dcidz":[function(require,module,exports) {
(function(e, t) {
...
},{}],"Qyk3J":[function(require,module,exports) {
(function(e, t) {
    const r = t(e);
    if (typeof exports["nodeName"] !== "string") module.exports = r;
    else {
        e["_hyperscript"] = r;
    ...
    const t = {
        dynamicResolvers: [
            function(e, t) {
                if (e === "Fixed") return Number(t).toFixed();
    ...
    class n {
        ...
        static isValidSingleQuoteStringStart(e) {
            if (e.length > 0) {
                var t = e[e.length - 1];
                if (t.type === "IDENTIFIER" || t.type === "CLASS_REF" || t.type === "ID_REF") return false;
                if (t.op && (t.value === ">" || t.value === ")")) return false;
            }
            return true;
        }
        static tokenize(e, t) {
            ...
            while(o < a.length){
                if (q() === "-" && N() === "-" && (n.isWhitespace(I(2)) || I(2) === "" || I(2) === "-") || q() === "/" && N() === "/" && (n.isWhitespace(I(2)) || I(2) === "" || I(2) === "/")) h();
                else if (q() === "/" && N() === "*" && (n.isWhitespace(I(2)) || I(2) === "" || I(2) === "*")) v();
                else {
                    if (n.isWhitespace(q())) r.push(A());
                    else if (!R() && q() === "." && (n.isAlpha(N()) || N() === "{" || N() === "-")) r.push(d());
                    else if (!R() && q() === "#" && (n.isAlpha(N()) || N() === "{")) r.push(k());
                    else if (q() === "[" && N() === "@") r.push(E());
                    else if (q() === "@") r.push(T());
                    else if (q() === "*" && n.isAlpha(N())) r.push(y());
                    else if (n.isAlpha(q()) || !f() && n.isIdentifierChar(q())) r.push(x());
                    else if (n.isNumeric(q())) r.push(g());
                    else if (!f() && (q() === '"' || q() === "`")) r.push(w());
                    else if (!f() && q() === "'") {
                        if (n.isValidSingleQuoteStringStart(r)) r.push(w());
                        else r.push(b());
                    } else if (n.OP_TABLE[q()]) {
                        if (l === "$" && q() === "{") c++;
                        if (q() === "}") c--;
                        r.push(b());
                    } else if (f() || n.isReservedChar(q())) r.push(p("RESERVED", C()));
                    else {
                        if (o < a.length) throw Error("Unknown token: " + q() + " ");
                    }
                }
            }
            return new i(r, [], a);
            ...
            function d() {
                ...
                } else while(n.isValidCSSClassChar(q()))t += C();
                e.value = t;
                e.end = o;
                return e;
            }
            ...
            function T() {
                var e = p("ATTRIBUTE_REF");
                var t = C();
                while(n.isValidCSSIDChar(q()))t += C();
                if (q() === "=") {
                    t += C();
                    if (q() === '"' || q() === "'") {
                        let e = w();
            ...
            function k() {
                ...
                } else while(n.isValidCSSIDChar(q()))t += C();
                e.value = t;
                e.end = o;
                return e;
            }
            function x() {
                var e = p("IDENTIFIER");
                var t = C();
                while(n.isAlpha(q()) || n.isNumeric(q()) || n.isIdentifierChar(q()))t += C();
                if (q() === "!" && t === "beep") t += C();
                e.value = t;
                e.end = o;
                return e;
            ...
            function g() {
                var e = p("NUMBER");
                var t = C();
                while(n.isNumeric(q()))t += C();
                if (q() === "." && n.isNumeric(N())) t += C();
                while(n.isNumeric(q()))t += C();
                if (q() === "e" || q() === "E") {
                    if (n.isNumeric(N())) t += C();
                    else if (N() === "-") {
                        t += C();
                        t += C();
                    }
            ...
            function w() {
                ...
                while(q() && q() !== t)if (q() === "\\") {
                    ...
                    if (t === "b") r += "\b";
                        ...
                        const t = S();
                        if (Number.isNaN(t)) throw Error("Invalid hexadecimal escape at " + n.positionString(e));
                        r += String.fromCharCode(t);
                    } else r += t;
                } else r += C();
                if (q() !== t) throw Error("Unterminated string at " + n.positionString(e));
                else C();
                e.value = r;
                e.end = o;
                e.template = t === "`";
    ...
    class i {
        ...
        requireOpToken(e) {
            ...
            if (t) return t;
            else this.raiseError(this, "Expected '" + e + "' but found '" + this.currentToken().value + "'");
        }
        ...
        matchOpToken(e) {
            if (this.currentToken() && this.currentToken().op && this.currentToken().value === e) return this.consumeToken();
        }
        requireTokenType(e, t, r, n) {
            var i = this.matchTokenType(e, t, r, n);
            if (i) return i;
            else this.raiseError(this, "Expected one of " + JSON.stringify([
                e,
                t,
                r
            ]));
        ...
        matchTokenType(e, t, r, n) {
            if (this.currentToken() && this.currentToken().type && [
                ...
                r,
                n
            ].indexOf(this.currentToken().type) >= 0) return this.consumeToken();
        }
        requireToken(e, t) {
        ...
        peekToken(e, t, r) {
            t = t || 0;
            r = r || "IDENTIFIER";
            if (this.tokens[t] && this.tokens[t].value === e && this.tokens[t].type === r) return this.tokens[t];
        }
        matchToken(e, t) {
            if (this.follows.indexOf(e) !== -1) return;
            t = t || "IDENTIFIER";
            if (this.currentToken() && this.currentToken().value === e && this.currentToken().type === t) return this.consumeToken();
        }
        consumeToken() {
        ...
        lastWhitespace() {
            if (this.consumed[this.consumed.length - 1] && this.consumed[this.consumed.length - 1].type === "WHITESPACE") return this.consumed[this.consumed.length - 1].value;
            else return "";
        }
        ...
        token(e, t) {
            ...
            var n = 0;
            do {
                if (!t) while(this.tokens[n] && this.tokens[n].type === "WHITESPACE")n++;
                r = this.tokens[n];
                e--;
                n++;
            }while (e > -1);
    ...
    class a {
        constructor(e){
            ...
            this.addGrammarElement("command", function(e, t, r) {
                ...
                let i;
                if (n) i = n(e, t, r);
                else if (r.currentToken().type === "IDENTIFIER") i = e.parseElement("pseudoCommand", r);
                if (i) return e.parseElement("indirectStatement", r, i);
                return i;
            });
            ...
            this.addGrammarElement("leaf", function(e, t, r) {
                ...
                if (n == null) return e.parseElement("symbol", r);
                return n;
            });
        ...
        commandBoundary(e) {
            if (e.value == "end" || e.value == "then" || e.value == "else" || e.value == "otherwise" || e.value == ")" || this.commandStart(e) || this.featureStart(e) || e.type == "EOF") return true;
            return false;
        }
        ...
        ensureTerminated(e) {
            ...
            var r = {
                ...
                op: function(e) {
                    ...
                    if (e.meta.resolve) e.meta.resolve();
                    return t.HALT;
                },
                execute: function(e) {}
            };
    ...
    class o {
        ...
        forEach(e, t) {
            if (e == null) ;
            else if (this.isIterable(e)) for (const r of e)t(r);
            else if (this.isArrayLike(e)) for(var r = 0; r < e.length; r++)t(e[r]);
            else t(e);
        }
        implicitLoop(e, t) {
        ...
        wrapArrays(e) {
            ...
            for(var r = 0; r < e.length; r++){
                var n = e[r];
                if (Array.isArray(n)) t.push(Promise.all(n));
                else t.push(n);
            }
            return t;
        }
        unwrapAsyncs(e) {
            for(var t = 0; t < e.length; t++){
                var r = e[t];
                if (r.asyncWrapper) e[t] = r.value;
                if (Array.isArray(r)) for(var n = 0; n < r.length; n++){
                    var i = r[n];
                    if (i.asyncWrapper) r[n] = i.value;
                }
            }
        }
        static HALT = {};
            ...
            while(true){
                ...
                if (r == null) {
                    ...
                    if (t.meta.finallyHandler && !t.meta.handlingFinally) {
                        ...
                        if (t.meta.onHalt) t.meta.onHalt();
        ...
        unifiedEval(e, t) {
            ...
            var n = false;
            var i = false;
            if (e.args) for(var a = 0; a < e.args.length; a++){
                var o = e.args[a];
                if (o == null) r.push(null);
            ...
            if (n) return new Promise((t, n)=>{
                r = this.wrapArrays(r);
                Promise.all(r).then(function(r) {
                    if (i) this.unwrapAsyncs(r);
                    try {
        ...
        _scriptAttrs = null;
        getScriptAttributes() {
            if (this._scriptAttrs == null) this._scriptAttrs = r.attributes.replace(/ /g, "").split(",");
        ...
        getScript(e) {
            ...
            if (e instanceof HTMLScriptElement && e.type === "text/hyperscript") return e.innerText;
            return null;
        }
        ...
        getHyperscriptFeatures(e) {
            ...
            if (typeof t === "undefined") {
                if (e) this.hyperscriptFeaturesMap.set(e, t = {});
            }
            return t;
        }
        addFeatures(e, t) {
        ...
        evaluateNoPromise(e, t) {
            let r = e.evaluate(t);
            if (r.next) throw new Error(i.sourceFor.call(e) + " returned a Promise in a context that they are not allowed.");
            return r;
        }
        evaluate(t, r, n) {
            ...
            if (o.execute) {
                o.execute(r);
                if (typeof r.meta.returnValue !== "undefined") return r.meta.returnValue;
                else return r.result;
            } else if (o.apply) {
                o.apply(a, a, n);
                return this.getHyperscriptFeatures(a);
            } else return o.evaluate(r);
            function s() {
                return {};
            }
        }
        processNode(e) {
            ...
            if (this.matchesSelector(e, t)) this.initElement(e, e);
            if (e instanceof HTMLScriptElement && e.type === "text/hyperscript") this.initElement(e, document.body);
            if (e.querySelectorAll) this.forEach(e.querySelectorAll(t + ", [type='text/hyperscript']"), (e)=>{
                this.initElement(e, e instanceof HTMLScriptElement && e.type === "text/hyperscript" ? document.body : e);
            });
        }
        initElement(e, t) {
            if (e.closest && e.closest(r.disableSelector)) return;
        ...
        getInternalData(e) {
            ...
            if (typeof t === "undefined") this.internalDataMap.set(e, t = {});
            return t;
        }
        typeCheck(e, t, r) {
            if (e == null && r) return true;
        ...
        getElementScope(e) {
            ...
            if (t) {
                ...
                var n = "elementScope";
                if (e.meta.feature && e.meta.feature.behavior) n = e.meta.feature.behavior + "Scope";
                var i = h(r, n);
                return i;
            } else return {};
        }
        ...
        resolveSymbol(t, r, n) {
            if (t === "me" || t === "my" || t === "I") return r.me;
            if (t === "it" || t === "its" || t === "result") return r.result;
            if (t === "you" || t === "your" || t === "yourself") return r.you;
            else {
                if (n === "global") return e[t];
                else if (n === "element") {
                    var i = this.getElementScope(r);
                    return i[t];
                } else if (n === "local") return r.locals[t];
                else {
                    ...
                    if (this.isHyperscriptContext(r) && !this.isReservedWord(t)) var o = r.locals[t];
                    else var o = r[t];
        ...
        setSymbol(t, r, n, i) {
            if (n === "global") e[t] = i;
                ...
                a[t] = i;
            } else if (n === "local") r.locals[t] = i;
            else if (this.isHyperscriptContext(r) && !this.isReservedWord(t) && typeof r.locals[t] !== "undefined") r.locals[t] = i;
            else {
                var a = this.getElementScope(r);
                var o = a[t];
                if (typeof o !== "undefined") a[t] = i;
                else if (this.isHyperscriptContext(r) && !this.isReservedWord(t)) r.locals[t] = i;
                else r[t] = i;
            }
        }
        findNext(e, t) {
            if (e) {
                if (e.resolveNext) return e.resolveNext(t);
                else if (e.next) return e.next;
                else return this.findNext(e.parent, t);
            }
        }
        flatGet(e, t, r) {
            if (e != null) {
        ...
        assignToNamespace(t, r, n, i) {
            let a;
            if (typeof document !== "undefined" && t === document.body) a = e;
            else a = this.getHyperscriptFeatures(t);
            var o;
        ...
        getHyperTrace(e, t) {
            var r = [];
            var n = e;
            while(n.meta.caller)n = n.meta.caller;
        ...
        registerHyperTrace(e, t) {
            ...
            if (n.meta.traceMap == null) n.meta.traceMap = new Map;
            if (!n.meta.traceMap.get(t)) {
                var i = {
                    ...
                    print: function(e) {
                        ...
                        e("hypertrace /// ");
                        var t = 0;
                        for(var n = 0; n < r.length; n++)t = Math.max(t, r[n].meta.feature.displayName.length);
                        for(var n = 0; n < r.length; n++){
                            var i = r[n];
        ...
        beepValueToConsole(e, t, r) {
            if (this.triggerEvent(e, "hyperscript:beep", {
                ...
                var n;
                if (r) {
                    if (r instanceof m) n = "ElementCollection";
                    else if (r.constructor) n = r.constructor.name;
                    else n = "unknown";
                } else n = "object (null)";
                var a = r;
                if (n === "String") a = '"' + a + '"';
                else if (r instanceof m) a = Array.from(r);
    ...
    function l() {
        for (const e of s())u(e.name);
    }
    const c = new Proxy({}, {
        get (e, t) {
            if (t === "then" || t === "asyncWrapper") return null;
            else if (t === "length") return s().length;
            else if (t === "clear") return u;
            else if (t === "clearAll") return l;
        ...
        set (e, t, r) {
            ...
            if ("string" === typeof r) {
                ...
                if (r.expires) n += ";expires=" + r.maxAge;
                if (r.maxAge) n += ";max-age=" + r.maxAge;
                if (r.partitioned) n += ";partitioned=" + r.partitioned;
                if (r.path) n += ";path=" + r.path;
                if (r.samesite) n += ";samesite=" + r.path;
                if (r.secure) n += ";secure=" + r.path;
            }
            document.cookie = t + "=" + n;
            return true;
        }
    ...
    class m {
        ...
        get css() {
            if (this.escape) return o.prototype.escapeSelector(this._css);
    ...
    function T(t) {
        ...
        t.addLeafExpression("string", function(e, t, r) {
            ...
            return {
                ...
                evaluate: function(e) {
                    ...
                    else return t.unifiedEval(this, e);
                }
            };
        });
        ...
        class r extends m {
            ...
            get css() {
                let e = "", t = 0;
                for (const r of this.templateParts)if (r instanceof Element) e += "[data-hs-query-id='" + t++ + "']";
                else e += r;
                return e;
            }
            [Symbol.iterator]() {
        ...
        t.addLeafExpression("queryRef", function(e, t, i) {
            ...
            return {
                ...
                args: c,
                op: function(e, ...t) {
                    if (u) return new r(s, e.me, t);
                    else return new m(s, e.me);
                },
                evaluate: function(e) {
                    return t.unifiedEval(this, e);
                }
        ...
        t.addLeafExpression("attributeRef", function(e, t, r) {
            ...
            if (!n.value) return;
            var i = n.value;
            if (i.indexOf("[") === 0) var a = i.substring(2, i.length - 1);
            else var a = i.substring(1);
            var o = "[" + a + "]";
            var s = a.split("=");
            var u = s[0];
            var l = s[1];
            if (l) {
                if (l.indexOf('"') === 0) l = l.substring(1, l.length - 1);
            }
            return {
                type: "attributeRef",
                name: u,
        ...
        t.addGrammarElement("objectKey", function(e, t, r) {
            var n;
            if (n = r.matchTokenType("STRING")) return {
                type: "objectKey",
                key: n.value,
                evaluate: function() {
                    return n.value;
        ...
        t.addLeafExpression("objectLiteral", function(e, t, r) {
            ...
            return {
                ...
                op: function(e, t, r) {
                    var n = {};
                    for(var i = 0; i < t.length; i++)n[t[i]] = r[i];
                    return n;
                },
                evaluate: function(e) {
                    return t.unifiedEval(this, e);
        ...
        t.addGrammarElement("nakedNamedArgumentList", function(e, t, r) {
            var n = [];
            var i = [];
            if (r.currentToken().type === "IDENTIFIER") do {
        ...
        t.addGrammarElement("symbol", function(e, t, r) {
            var n = "default";
            if (r.matchToken("global")) n = "global";
            else if (r.matchToken("element") || r.matchToken("module")) {
                n = "element";
                if (r.matchOpToken("'")) r.requireToken("s");
            } else if (r.matchToken("local")) n = "local";
            ...
            if (a && a.value) {
                ...
                if (i) o = ":" + o;
                if (n === "default") {
                    if (o.indexOf("$") === 0) n = "global";
                    if (o.indexOf(":") === 0) n = "element";
                }
                return {
                    type: "symbol",
                    token: a,
        ...
        t.addLeafExpression("blockLiteral", function(e, t, r) {
            ...
            if (i) {
                n.push(i);
                while(r.matchOpToken(","))n.push(r.requireTokenType("IDENTIFIER"));
            }
            r.requireOpToken("-");
            r.requireOpToken(">");
            ...
            return {
                ...
                evaluate: function(e) {
                    var t = function() {
                        for(var t = 0; t < n.length; t++)e.locals[n[t].value] = arguments[t];
                        return a.evaluate(e);
                    };
                    return t;
                }
        ...
        t.addIndirectExpression("of", function(e, t, r, n) {
            ...
            if (o.type !== "symbol" && o.type !== "attributeRef" && o.type !== "styleRef" && o.type !== "computedStyleRef") e.raiseParseError(r, "Cannot take a property of a non-symbol: " + o.type);
            ...
            var f = {
                ...
                op: function(e, r) {
                    if (s) return t.resolveAttribute(r, c);
                    else if (u) {
                        if (o.type === "computedStyleRef") return t.resolveComputedStyle(r, c);
                        else return t.resolveStyle(r, c);
                    } else return t.resolveProperty(r, c);
                },
                evaluate: function(e) {
                    return t.unifiedEval(this, e);
                }
            };
            if (o.type === "attributeRef") f.attribute = o;
            if (a) {
                a.root = f;
                a.args = [
                    f
        ...
        t.addIndirectExpression("possessive", function(e, t, r, n) {
            if (e.possessivesDisabled) return;
            ...
            if (i || n.type === "symbol" && (n.name === "my" || n.name === "its" || n.name === "your") && (r.currentToken().type === "IDENTIFIER" || r.currentToken().type === "ATTRIBUTE_REF" || r.currentToken().type === "STYLE_REF")) {
                if (i) r.requireToken("s");
                var a, o, s;
                a = e.parseElement("attributeRef", r);
                if (a == null) {
                    o = e.parseElement("styleRef", r);
                    if (o == null) s = r.requireTokenType("IDENTIFIER");
                }
                var u = {
                    type: "possessive",
                    root: n,
                    ...
                    op: function(e, r) {
                        if (a) var n = t.resolveAttribute(r, a.name);
                        else if (o) {
                            var n;
                            if (o.type === "computedStyleRef") n = t.resolveComputedStyle(r, o["name"]);
                            else n = t.resolveStyle(r, o["name"]);
        ...
        t.addIndirectExpression("inExpression", function(e, t, r, n) {
            ...
            var a = {
                ...
                op: function(e, r, n) {
                    var i = [];
                    if (r.css) t.implicitLoop(n, function(e) {
                        ...
                        t.implicitLoop(n, function(e) {
                            if (e.contains(r)) a = true;
                        });
                        if (a) return r;
                    } else t.implicitLoop(r, function(e) {
        ...
        t.addIndirectExpression("arrayIndex", function(e, t, r, n) {
            ...
            if (r.matchOpToken("..")) {
                ...
                if (r.matchOpToken("..")) {
                    ...
                    if (u.type !== "R_BRACKET") s = e.parseElement("expression", r);
                }
            }
            r.requireOpToken("]");
            var l = {
        ...
        t.addGrammarElement("postfixExpression", function(e, t, r) {
            ...
            var o = null;
            if (r.matchToken("s") || r.matchToken("seconds")) o = 1e3;
            else if (r.matchToken("ms") || r.matchToken("milliseconds")) o = 1;
            if (o) return {
                type: "timeExpression",
                time: n,
                factor: o,
            ...
            if (r.matchOpToken(":")) {
                ...
                return {
                    ...
                    op: function(e, r) {
                        ...
                        if (n) return r;
                        else throw new Error("Typecheck failed!  Expected: " + s.value);
                    },
                    evaluate: function(e) {
                        return t.unifiedEval(this, e);
                    }
        ...
        var s = function(e, t, r, n) {
            ...
            for(var a = 0; a < i.length; a++){
                var o = i[a];
                if (o.compareDocumentPosition(e) === Node.DOCUMENT_POSITION_PRECEDING) return o;
            }
            if (n) return i[0];
        };
        var u = function(e, t, r, n) {
            ...
            for(var a = i.length - 1; a >= 0; a--){
                var o = i[a];
                if (o.compareDocumentPosition(e) === Node.DOCUMENT_POSITION_FOLLOWING) return o;
            }
        ...
        t.addGrammarElement("relativePositionalExpression", function(e, t, r) {
            ...
            } else var f = e.requireElement("implicitMeTarget", r);
            var m = false;
            var p;
            if (r.matchToken("in")) {
                m = true;
                var h = e.requireElement("unaryExpression", r);
            } else if (r.matchToken("within")) p = e.requireElement("unaryExpression", r);
            ...
            return {
                ...
                op: function(e, t, r, n, f) {
                    var p = t.css;
                    if (p == null) throw "Expected a CSS value to be returned by " + i.sourceFor.apply(o);
                    if (m) {
                        if (n) {
                            if (a) return l(r, n, p, v);
                            else return c(r, n, p, v);
                        }
                    } else if (f) {
                        if (a) return s(r, f, p, v);
                        else return u(r, f, p, v);
                    }
                },
                evaluate: function(e) {
                    return t.unifiedEval(this, e);
        ...
        t.addGrammarElement("positionalExpression", function(e, t, r) {
            ...
            return {
                ...
                op: function(e, t) {
                    ...
                    if (t) {
                        if (a === "first") return t[0];
                        else if (a === "last") return t[t.length - 1];
                        else if (a === "random") return t[Math.floor(Math.random() * t.length)];
                    }
                },
                evaluate: function(e) {
                    return t.unifiedEval(this, e);
        ...
        t.addGrammarElement("mathOperator", function(e, t, r) {
            ...
            while(i){
                a = a || i;
                var o = i.value;
                if (a.value !== o) e.raiseParseError(r, "You must parenthesize math operations with different operators");
                ...
                n = {
                    ...
                    op: function(e, t, r) {
                        if (o === "+") return t + r;
                        else if (o === "-") return t - r;
                        else if (o === "*") return t * r;
                        else if (o === "/") return t / r;
                        else if (o === "mod") return t % r;
                    },
                    evaluate: function(e) {
                        return t.unifiedEval(this, e);
                    }
        ...
        function f(e, t, r) {
            ...
            else if (t["includes"]) return t.includes(r);
            else throw Error("The value of " + e.sourceFor() + " does not have a contains or includes method on it");
        }
        function p(e, t, r) {
            if (t["match"]) return !!t.match(r);
            else if (t["matches"]) return t.matches(r);
            else throw Error("The value of " + e.sourceFor() + " does not have a match or matches method on it");
        }
                ...
                if (r.matchToken("is") || r.matchToken("am")) {
                    if (r.matchToken("not")) {
                        if (r.matchToken("in")) a = "not in";
                            ...
                            if (r.matchToken("really")) a = "!==";
                            else a = "!=";
                            if (r.matchToken("equal")) r.matchToken("to");
                        }
                    } else if (r.matchToken("in")) a = "in";
                    else if (r.matchToken("a")) {
                        a = "a";
                        s = true;
                    } else if (r.matchToken("empty")) {
                    ...
                    a = "exist";
                    o = false;
                } else if (r.matchToken("matches") || r.matchToken("match")) a = "match";
                else if (r.matchToken("contains") || r.matchToken("contain")) a = "contain";
                else if (r.matchToken("includes") || r.matchToken("include")) a = "include";
                else if (r.matchToken("do") || r.matchToken("does")) {
                    r.requireToken("not");
                    if (r.matchToken("matches") || r.matchToken("match")) a = "not match";
                    else if (r.matchToken("contains") || r.matchToken("contain")) a = "not contain";
                    else if (r.matchToken("exist") || r.matchToken("exist")) {
                        a = "not exist";
                        o = false;
                    } else if (r.matchToken("include")) a = "not include";
                    else e.raiseParseError(r, "Expected matches or contains");
                }
            }
            if (a) {
                var u, l, c;
                if (s) {
                    ...
                    if (a === "match" || a === "not match") c = c.css ? c.css : c;
                }
                var m = n;
                n = {
                    ...
                    op: function(e, r, n) {
                        if (a === "==") return r == n;
                        else if (a === "!=") return r != n;
                        if (a === "===") return r === n;
                        else if (a === "!==") return r !== n;
                        if (a === "match") return r != null && p(m, r, n);
                        if (a === "not match") return r == null || !p(m, r, n);
                        if (a === "in") return n != null && f(c, n, r);
                        if (a === "not in") return n == null || !f(c, n, r);
                        if (a === "contain") return r != null && f(m, r, n);
                        if (a === "not contain") return r == null || !f(m, r, n);
                        if (a === "include") return r != null && f(m, r, n);
                        if (a === "not include") return r == null || !f(m, r, n);
                        if (a === "===") return r === n;
                        else if (a === "!==") return r !== n;
                        else if (a === "<") return r < n;
                        else if (a === ">") return r > n;
                        ...
                        else if (a === "empty") return t.isEmpty(r);
                        else if (a === "not empty") return !t.isEmpty(r);
                        else if (a === "exist") return t.doesExist(r);
                        else if (a === "not exist") return !t.doesExist(r);
                        else if (a === "a") return t.typeCheck(r, u.value, l);
                        else if (a === "not a") return !t.typeCheck(r, u.value, l);
                        else throw "Unknown comparison : " + a;
                    },
                    evaluate: function(e) {
                        return t.unifiedEval(this, e);
                    }
        ...
        t.addGrammarElement("logicalOperator", function(e, t, r) {
            ...
            while(i){
                a = a || i;
                if (a.value !== i.value) e.raiseParseError(r, "You must parenthesize logical operations with different operators");
        ...
        t.addGrammarElement("asyncExpression", function(e, t, r) {
            if (r.matchToken("async")) {
                ...
                return i;
            } else return e.parseElement("logicalExpression", r);
        });
        ...
        t.addGrammarElement("assignableExpression", function(e, t, r) {
            r.matchToken("the");
            var n = e.parseElement("primaryExpression", r);
            if (n && (n.type === "symbol" || n.type === "ofExpression" || n.type === "propertyAccess" || n.type === "attributeRefAccess" || n.type === "attributeRef" || n.type === "styleRef" || n.type === "arrayIndex" || n.type === "possessive")) return n;
            else e.raiseParseError(r, "A target expression must be writable.  The expression type '" + (n && n.type) + "' is not.");
            return n;
        });
        t.addGrammarElement("hyperscript", function(e, t, r) {
            var n = [];
            if (r.hasMore()) while(e.featureStart(r.currentToken()) || r.currentToken().value === "("){
            ...
            return {
                ...
                apply: function(e, t, r) {
                    for (const i of n)i.install(e, t, r);
                }
            };
        });
        var v = function(e) {
        ...
        t.addFeature("on", function(e, t, r) {
            ...
            do {
                ...
                if (s === "intersection") {
                    d = {};
                    if (r.matchToken("with")) d["with"] = e.requireElement("expression", r).evaluate();
                    if (r.matchToken("having")) do {
                        if (r.matchToken("margin")) d["rootMargin"] = e.requireElement("stringLike", r).evaluate();
                        else if (r.matchToken("threshold")) d["threshold"] = e.requireElement("expression", r).evaluate();
                        else e.raiseParseError(r, "Unknown intersection config specification");
                    }while (r.matchToken("and"));
                } else if (s === "mutation") {
                    E = {};
                    if (r.matchToken("of")) do {
                        if (r.matchToken("anything")) {
                            E["attributes"] = true;
                            E["subtree"] = true;
                            E["characterData"] = true;
                            E["childList"] = true;
                        } else if (r.matchToken("childList")) E["childList"] = true;
                        else if (r.matchToken("attributes")) {
                            E["attributes"] = true;
                            E["attributeOldValue"] = true;
                        } else if (r.matchToken("subtree")) E["subtree"] = true;
                            ...
                            if (E["attributeFilter"] == null) E["attributeFilter"] = [];
                            if (T.value.indexOf("@") == 0) E["attributeFilter"].push(T.value.substring(1));
                            else e.raiseParseError(r, "Only shorthand attribute references are allowed here");
                        } else e.raiseParseError(r, "Unknown mutation config specification");
                ...
                var k = false;
                if (r.matchToken("from")) {
                    if (r.matchToken("elsewhere")) k = true;
                    else {
                        r.pushFollow("or");
                        try {
                        ...
                        if (!y) e.raiseParseError(r, 'Expected either target value or "elsewhere".');
                    }
                }
                if (y === null && k === false && r.matchToken("elsewhere")) k = true;
                if (r.matchToken("in")) var x = e.parseElement("unaryExpression", r);
            ...
            if (!n) {
                if (r.matchToken("queue")) {
                    if (r.matchToken("all")) {
                        var q = true;
                        var S = false;
                    } else if (r.matchToken("first")) var N = true;
                    else if (r.matchToken("none")) var I = true;
            ...
            var O = {
                ...
                execute: function(e) {
                    ...
                    if (r.executing && n === false) {
                        if (I || N && r.queue.length > 0) return;
                ...
                install: function(e, r) {
                    for (const r of O.events){
                        ...
                        else if (r.from) n = r.from.evaluate(t.makeContext(e, O, e, null));
                        else n = [
                            e
                        ];
                        t.implicitLoop(n, function(n) {
                            ...
                            if (r.mutationSpec) {
                                ...
                                const e = new MutationObserver(function(e, r) {
                                    if (!O.executing) t.triggerEvent(n, i, {
                                        mutationList: e,
                                        observer: r
                                    });
                                });
                            ...
                            o.call(n, i, function a(o) {
                                ...
                                if (r.elsewhere && e.contains(o.target)) return;
                                if (r.from) s.result = n;
                                for (const e of r.args){
                                    let t = s.event[e.value];
                                    if (t !== undefined) s.locals[e.value] = t;
                                    else if ("detail" in s.event) s.locals[e.value] = s.event["detail"][e.value];
                                }
                                ...
                                if (r.inExpr) {
                                    var c = o.target;
                                    while(true)if (c.matches && c.matches(r.inExpr.css)) {
                                        s.result = c;
                                        break;
                                    } else {
                                        c = c.parentElement;
                                ...
                                if (r.startCount) {
                                    if (r.endCount) {
                                        if (r.execCount < r.startCount || r.execCount > r.endCount) return;
                                    } else if (r.unbounded) {
                                        if (r.execCount < r.startCount) return;
                                    } else if (r.execCount !== r.startCount) return;
                                }
                                if (r.debounceTime) {
                                    if (r.debounced) clearTimeout(r.debounced);
                                ...
                                if (r.throttleTime) {
                                    if (r.lastExec && Date.now() < r.lastExec + r.throttleTime) return;
                                    else r.lastExec = Date.now();
                                }
                                O.execute(s);
                            });
                        });
        ...
        t.addFeature("def", function(e, t, r) {
            ...
            if (r.matchOpToken("(")) {
                if (r.matchOpToken(")")) ;
                    ...
                    do s.push(r.requireTokenType("IDENTIFIER"));
                    while (r.matchOpToken(","));
                    r.requireOpToken(")");
                }
            }
                ...
                install: function(e, r) {
                    var n = function() {
                        ...
                        for(var i = 0; i < s.length; i++){
                            var a = s[i];
                            var o = arguments[i];
                            if (a) n.locals[a.value] = o;
                        }
                        n.meta.caller = arguments[s.length];
                        if (n.meta.caller) n.meta.callingCommand = n.meta.caller.meta.command;
                        var p, h = null;
                        ...
                        u.execute(n);
                        if (n.meta.returned) return n.meta.returnValue;
                        else {
                            n.meta.resolve = p;
                            n.meta.reject = h;
                            return v;
        ...
        t.addFeature("set", function(e, t, r) {
            ...
            if (n) {
                if (n.target.scope !== "element") e.raiseParseError(r, "variables declared at the feature level must be element scoped.");
                let i = {
                    start: n,
                    install: function(e, r) {
            ...
            return {
                install: function(t, n) {
                    r.assignToNamespace(e.document && e.document.body, a, o, function(e, t, n) {
                        ...
                        var o = h(a, i + "Scope");
                        for(var l = 0; l < s.length; l++)o[s[l]] = n[s[l]];
                        u.apply(e, t);
                    });
                }
            };
        ...
        t.addGrammarElement("jsBody", function(e, t, r) {
            ...
            while(r.hasMore()){
                ...
                if (u.type === "IDENTIFIER" && u.value === "end") break;
                if (s) {
                    if (i.type === "IDENTIFIER" || i.type === "NUMBER") o += i.value;
                    else {
                        if (o !== "") a.push(o);
                        o = "";
                        s = false;
                    }
                } else if (i.type === "IDENTIFIER" && i.value === "function") s = true;
            }
            var l = i.end + 1;
            return {
                type: "jsBody",
        ...
        t.addCommand("js", function(t, r, n) {
            ...
            var u = {
                ...
                op: function(t) {
                    ...
                    var a = s.apply(e, n);
                    if (a && typeof a.then === "function") return new Promise(function(e) {
                        a.then(function(n) {
                            t.result = n;
                            e(r.findNext(this, t));
                        });
        ...
        t.addCommand("tell", function(e, t, r) {
            ...
            if (r.hasMore() && !e.featureStart(r.currentToken())) r.requireToken("end");
            var o = "tell_" + n.start;
            var s = {
                value: i,
                body: a,
                ...
                resolveNext: function(e) {
                    ...
                    if (r.index < r.value.length) {
                        ...
                        else return t.findNext(this.parent, e);
                    }
                },
                op: function(e, t) {
                    if (t == null) t = [];
                    else if (!(Array.isArray(t) || t instanceof NodeList)) t = [
                        t
                    ];
                    e.meta.iterators[o] = {
                        originalYou: e.you,
        ...
        t.addCommand("wait", function(e, t, r) {
            ...
            if (r.matchToken("for")) {
                ...
                do {
                    var a = r.token(0);
                    if (a.type === "NUMBER" || a.type === "L_PAREN") i.push({
                ...
                if (r.matchToken("from")) var o = e.requireElement("expression", r);
                n = {
                    event: i,
                    on: o,
                    args: [
                    ...
                    op: function(e, r) {
                        ...
                        return new Promise((r)=>{
                            ...
                            for (const s of i){
                                var o = (n)=>{
                                    e.result = n;
                                    if (s.args) for (const t of s.args)e.locals[t.value] = n[t.value] || (n.detail ? n.detail[t.value] : null);
                                    if (!a) {
                                        a = true;
                                        r(t.findNext(this, e));
                                    }
                                };
                                if (s.name) n.addEventListener(s.name, o, {
                                    once: true
                                });
                                else if (s.time != null) setTimeout(o, s.time, s.time);
                            }
                        });
                    }
                };
                ...
                if (r.matchToken("a")) {
                    r.requireToken("tick");
                    s = 0;
                } else s = e.requireElement("expression", r);
                n = {
                    type: "waitCmd",
                    time: s,
                    args: [
        ...
        t.addGrammarElement("dotOrColonPath", function(e, t, r) {
            ...
            if (n) {
                ...
                if (a) do i.push(r.requireTokenType("IDENTIFIER", "NUMBER").value);
        ...
        function d(e, t, r, n) {
            ...
            if (e === "send" && n.matchToken("to") || e === "trigger" && n.matchToken("on")) var o = t.requireElement("expression", n);
            else var o = t.requireElement("implicitMeTarget", n);
            var s = {
                eventName: i,
                details: a,
                to: o,
        ...
        t.addCommand("trigger", function(e, t, r) {
            if (r.matchToken("trigger")) return d("trigger", e, t, r);
        });
        t.addCommand("send", function(e, t, r) {
            if (r.matchToken("send")) return d("send", e, t, r);
        });
        var T = function(e, t, r, n) {
            if (n) {
                if (e.commandBoundary(r.currentToken())) e.raiseParseError(r, "'return' commands must return a value.  If you do not wish to return a value, use 'exit' instead.");
        ...
        t.addCommand("return", function(e, t, r) {
            if (r.matchToken("return")) return T(e, t, r, true);
        });
        t.addCommand("exit", function(e, t, r) {
            if (r.matchToken("exit")) return T(e, t, r, false);
        });
        t.addCommand("halt", function(e, t, r) {
            if (r.matchToken("halt")) {
                ...
                if (r.matchToken("bubbling")) var i = true;
                else if (r.matchToken("default")) var a = true;
                var o = T(e, t, r, false);
                var s = {
                    keepExecuting: true,
                    bubbling: i,
                    ...
                    op: function(e) {
                        if (e.event) {
                            if (i) e.event.stopPropagation();
                            else if (a) e.event.preventDefault();
                            else {
                                e.event.stopPropagation();
                                e.event.preventDefault();
                            }
                            if (n) return t.findNext(this, e);
                            else return o;
                        }
                    }
                };
        ...
        t.addCommand("log", function(e, t, r) {
            ...
            while(r.matchOpToken(","))n.push(e.requireElement("expression", r));
        ...
        t.addCommand("call", function(e, t, r) {
            ...
            var n = y(e, t, r);
            if (n.expr && n.expr.type !== "functionCall") e.raiseParseError(r, "Must be a function invocation");
            return n;
        });
        ...
        t.addCommand("make", function(e, t, r) {
            ...
            var n = e.requireElement("expression", r);
            var i = [];
            if (n.type !== "queryRef" && r.matchToken("from")) do i.push(e.requireElement("expression", r));
            while (r.matchOpToken(","));
            ...
            if (n.type === "queryRef") {
                o = {
                    op: function(e) {
                        ...
                        e.result = l;
                        if (a) t.setSymbol(a.name, e, a.scope, l);
                        return t.findNext(this, e);
                    }
                };
                return o;
                ...
                o = {
                    ...
                    op: function(e, r, n) {
                        e.result = E(r, n);
                        if (a) t.setSymbol(a.name, e, a.scope, e.result);
                        return t.findNext(this, e);
                    }
                };
                return o;
        ...
        t.addGrammarElement("pseudoCommand", function(e, t, r) {
            ...
            if (i.type !== "functionCall") e.raiseParseError(r, "Pseudo-commands must be function calls");
            if (o.type === "functionCall" && o.root.root == null) {
                if (r.matchAnyToken("the", "to", "on", "with", "into", "from", "at")) var s = e.requireElement("expression", r);
                else if (r.matchToken("me")) var s = e.requireElement("implicitMeTarget", r);
            }
            var u;
            if (s) u = {
                type: "pseudoCommand",
        ...
        var k = function(e, t, r, n, i) {
            ...
            if (!(o || s || a) && n.root == null) e.raiseParseError(r, "Can only put directly into symbols, not references");
            var l = null;
            var c = null;
            if (a) ;
            else if (o || s) {
            ...
            var m = {
                ...
                op: function(e, r, i, o) {
                    if (a) t.setSymbol(n.name, e, n.scope, o);
                    else {
                        t.nullCheck(r, l);
                        if (u) r[i] = o;
                        else t.implicitLoop(r, function(e) {
                            if (f) {
                                if (f.type === "attributeRef") {
                                    if (o == null) e.removeAttribute(f.name);
                                    else e.setAttribute(f.name, o);
                                } else e.style[f.name] = o;
                            } else e[i] = o;
                        });
                    }
                    return t.findNext(this, e);
        ...
        t.addCommand("if", function(e, t, r) {
            ...
            if (o) {
                ...
                if (a) var s = e.parseElement("command", r);
                else var s = e.parseElement("commandList", r);
            }
            if (r.hasMore() && !a) r.requireToken("end");
            var u = {
                expr: n,
                trueBranch: i,
                falseBranch: s,
        ...
        var x = function(e, t, r, n) {
            ...
            if (t.matchToken("for") || n) {
                ...
                a = "it";
                var s = e.requireElement("expression", t);
            } else if (t.matchToken("while")) var u = e.requireElement("expression", t);
            ...
            } else if (!e.commandBoundary(t.currentToken()) && t.currentToken().value !== "forever") {
            ...
            if (t.hasMore()) t.requireToken("end");
            if (a == null) {
                a = "_implicit_repeat_" + i.start;
                var T = a;
            } else var T = a + "_" + i.start;
            var y = {
                identifier: a,
                indexIdentifier: h,
                slot: T,
                ...
                op: function(e, t, n) {
                    ...
                    var o = false;
                    var s = null;
                    if (this.forever) o = true;
                    else if (this.until) {
                        if (c) o = e.meta.iterators[T].eventFired === false;
                        else o = t !== true;
                    } else if (u) o = t;
                    else if (n) o = i.index < n;
                    else {
                    ...
                    if (o) {
                        if (i.value) e.result = e.locals[a] = s;
                        else e.result = i.index;
                        if (h) e.locals[h] = i.index;
                        i.index++;
                        return v;
                    } else {
            ...
            var k = {
                ...
                op: function(e, t, r, n) {
                    ...
                    if (t && t[Symbol.iterator]) i.iterator = t[Symbol.iterator]();
                    if (c) {
                        var a = n || e.me;
        ...
        t.addCommand("repeat", function(e, t, r) {
            if (r.matchToken("repeat")) return x(e, r, t, false);
        });
        t.addCommand("for", function(e, t, r) {
            if (r.matchToken("for")) return x(e, r, t, true);
        });
            ...
            var n = {
                op: function(t) {
                    for(var n = this.parent;; n = n.parent){
                        if (n == undefined) e.raiseParseError(r, "Command `continue` cannot be used outside of a `repeat` loop.");
                        if (n.loop != undefined) return n.resolveNext(t);
                    }
                }
            };
            return n;
            ...
            var n = {
                op: function(n) {
                    for(var i = this.parent;; i = i.parent){
                        if (i == undefined) e.raiseParseError(r, "Command `continue` cannot be used outside of a `repeat` loop.");
                        if (i.loop != undefined) return t.findNext(i.parent, n);
                    }
                }
            };
            return n;
        ...
        t.addCommand("append", function(e, t, r) {
            ...
            if (r.matchToken("to")) n = e.requireElement("expression", r);
            else n = a;
            var o = null;
            if (n.type === "symbol" || n.type === "attributeRef" || n.root != null) o = k(e, t, r, n, a);
            var s = {
                value: i,
                target: n,
                args: [
                ...
                op: function(e, r, n) {
                    if (Array.isArray(r)) {
                        ...
                        e.result = (r || "") + n;
                        return o;
                    } else throw Error("Unable to append a value!");
                },
                execute: function(e) {
                    return t.unifiedExec(this, e);
                }
            };
            if (o != null) o.parent = s;
            return s;
        });
        function g(e, t, r) {
            ...
            if (r.matchToken("to") || r.matchOpToken("..")) {
                if (r.matchToken("end")) n.toEnd = true;
                else n.to = e.requireElement("expression", r);
            }
        ...
        t.addCommand("pick", (e, t, r)=>{
            ...
            if (r.matchToken("match")) {
                ...
                let i = "";
                if (r.matchOpToken("|")) i = r.requireToken("identifier").value;
                r.requireToken("from");
            ...
            if (r.matchToken("matches")) {
                ...
                const n = e.parseElement("expression", r);
                let i = "gu";
                if (r.matchOpToken("|")) i = "g" + r.requireToken("identifier").value.replace("g", "");
                console.log("flags", i);
                r.requireToken("from");
                const a = e.parseElement("expression", r);
                return {
        ...
        t.addCommand("increment", function(e, t, r) {
            ...
            if (r.matchToken("by")) n = e.requireElement("expression", r);
            var a = {
        ...
        function S(e, t) {
            ...
            if (e.matchToken("json") || e.matchToken("Object")) r = "json";
            else if (e.matchToken("response")) r = "response";
            else if (e.matchToken("html")) r = "html";
            else if (e.matchToken("text")) ;
            else n = t.requireElement("dotOrColonPath", e).evaluate();
            return {
                type: r,
                conversion: n
            };
        ...
        t.addCommand("fetch", function(e, t, r) {
            ...
            if (r.matchToken("as")) var i = S(r, e);
            if (r.matchToken("with") && r.currentToken().value !== "{") var a = e.parseElement("nakedNamedArgumentList", r);
            else var a = e.parseElement("objectLiteral", r);
            if (i == null && r.matchToken("as")) i = S(r, e);
            var o = i ? i.type : "text";
            ...
            var u = {
                ...
                op: function(e, r, n) {
                    ...
                    n = i;
                    var c = false;
                    if (n.timeout) setTimeout(function() {
                        if (!c) a.abort();
                    }, n.timeout);
                    return fetch(r, n).then(function(r) {
                        ...
                        if (o === "json") return r.json().then(function(r) {
                            e.result = r;
                            t.triggerEvent(e.me, "fetch:afterRequest", {
                                result: r
                            });
    ...
    function y(e) {
        e.addCommand("settle", function(e, t, r) {
            if (r.matchToken("settle")) {
                if (!e.commandBoundary(r.currentToken())) var n = e.requireElement("expression", r);
                else var n = e.requireElement("implicitMeTarget", r);
                var i = {
                    type: "settleCmd",
                    args: [
                        n
                    ...
                    op: function(e, r) {
                        ...
                        setTimeout(function() {
                            if (!s && !o) a(t.findNext(i, e));
                        }, 500);
                        r.addEventListener("transitionend", function() {
                            if (!o) a(t.findNext(i, e));
                        }, {
                            once: true
                        });
                        return u;
            ...
            if (r.matchToken("add")) {
                ...
                if (n == null) {
                    ...
                    if (i == null) {
                        ...
                        if (a == null) e.raiseParseError(r, "Expected either a class reference or attribute expression");
                    }
                } else {
                    var o = [
                        n
                    ];
                    while(n = e.parseElement("classRef", r))o.push(n);
                }
                if (r.matchToken("to")) var s = e.requireElement("expression", r);
                else var s = e.requireElement("implicitMeTarget", r);
                if (r.matchToken("when")) {
                    if (a) e.raiseParseError(r, "Only class and properties are supported with a when clause");
                        ...
                        t.forEach(n, function(n) {
                            t.implicitLoop(r, function(r) {
                                if (u) {
                                    ...
                                    } else if (r instanceof Element) r.classList.remove(n.className);
                                    e.result = null;
                                } else if (r instanceof Element) r.classList.add(n.className);
                            });
                        });
                        return t.findNext(this, e);
                    }
                    ...
                    op: function(e, r, n) {
                        ...
                        t.implicitLoop(r, function(r) {
                            if (u) {
                                ...
                                if (n) r.setAttribute(i.name, i.value);
                                else r.removeAttribute(i.name);
                                e.result = null;
                            } else r.setAttribute(i.name, i.value);
                        });
                        return t.findNext(this, e);
                    },
                    execute: function(e) {
            ...
            if (r.matchToken("remove")) {
                ...
                if (n == null) {
                    ...
                    if (i == null) {
                        ...
                        if (a == null) e.raiseParseError(r, "Expected either a class reference, attribute expression or value expression");
                    }
                } else {
                    var o = [
                        n
                ...
                else if (a == null) var s = e.requireElement("implicitMeTarget", r);
                if (a) return {
                    elementExpr: a,
                    from: s,
                    args: [
                    ...
                    op: function(e, r, n) {
                        t.nullCheck(r, a);
                        t.implicitLoop(r, function(e) {
                            if (e.parentElement && (n == null || n.contains(e))) e.parentElement.removeChild(e);
                        });
                        return t.findNext(this, e);
                    }
                };
                    ...
                    op: function(e, r, n) {
                        t.nullCheck(n, s);
                        if (r) t.forEach(r, function(e) {
                            t.implicitLoop(n, function(t) {
                                t.classList.remove(e.className);
                            });
                        });
                        else t.implicitLoop(n, function(e) {
            ...
            if (r.matchToken("toggle")) {
                ...
                if (r.currentToken().type === "STYLE_REF") {
                    ...
                    if (l == null) {
                        ...
                        if (f == null) e.raiseParseError(r, "Expected either a class reference or attribute expression");
                    } else {
                        var m = [
                            l
                        ];
                        while(l = e.parseElement("classRef", r))m.push(l);
                    }
                }
                if (a !== true) {
                ...
                if (r.matchToken("for")) var p = e.requireElement("expression", r);
                else if (r.matchToken("until")) {
                    var h = e.requireElement("dotOrColonPath", r, "Expected event name");
                    if (r.matchToken("from")) var v = e.requireElement("expression", r);
                }
                var d = {
                    classRef: l,
                    classRef2: c,
                    ...
                    toggle: function(e, r, n, i) {
                        t.nullCheck(e, s);
                        if (a) t.implicitLoop(e, function(e) {
                            o("toggle", e);
                        });
                        else if (u) t.implicitLoop(e, function(e) {
                        ...
                        else if (i) t.forEach(i, function(r) {
                            t.implicitLoop(e, function(e) {
                                e.classList.toggle(r.className);
                            });
                        });
                        else t.forEach(e, function(e) {
                            if (e.hasAttribute(f.name)) e.removeAttribute(f.name);
                            else e.setAttribute(f.name, f.value);
                        });
                    },
                    args: [
                        s,
                    ...
                    op: function(e, r, n, i, a, o, s, u) {
                        if (n) return new Promise(function(i) {
                            d.toggle(r, o, s, u);
                            setTimeout(function() {
                                d.toggle(r, o, s, u);
                                i(t.findNext(d, e));
                        ...
                        else if (i) return new Promise(function(n) {
                            var l = a || e.me;
        ...
        var t = {
            display: function(r, n, i) {
                if (i) n.style.display = i;
                    ...
                    if (getComputedStyle(n).display === "none") t.display("show", n, i);
                    else t.display("hide", n, i);
                } else if (r === "hide") {
                    const t = e.runtime.getInternalData(n);
                    if (t.originalDisplay == null) t.originalDisplay = n.style.display;
                    n.style.display = "none";
                } else {
                    const t = e.runtime.getInternalData(n);
                    if (t.originalDisplay && t.originalDisplay !== "none") n.style.display = t.originalDisplay;
                    else n.style.removeProperty("display");
                }
            },
            visibility: function(e, r, n) {
                if (n) r.style.visibility = n;
                else if (e === "toggle") {
                    if (getComputedStyle(r).visibility === "hidden") t.visibility("show", r, n);
                    else t.visibility("hide", r, n);
                } else if (e === "hide") r.style.visibility = "hidden";
                else r.style.visibility = "visible";
            },
            opacity: function(e, r, n) {
                if (n) r.style.opacity = n;
                else if (e === "toggle") {
                    if (getComputedStyle(r).opacity === "0") t.opacity("show", r, n);
                    else t.opacity("hide", r, n);
                } else if (e === "hide") r.style.opacity = "0";
        ...
        var n = function(e, t, r) {
            var n;
            var i = r.currentToken();
            if (i.value === "when" || i.value === "with" || e.commandBoundary(i)) n = e.parseElement("implicitMeTarget", r);
            else n = e.parseElement("expression", r);
            return n;
        };
        var i = function(e, n, i) {
            var a = r.defaultHideShowStrategy;
            var o = t;
            if (r.hideShowStrategies) o = Object.assign(o, r.hideShowStrategies);
            i = i || a || "display";
            var s = o[i];
            if (s == null) e.raiseParseError(n, "Unknown show/hide strategy : " + i);
            return s;
        };
        ...
        e.addCommand("take", function(e, t, r) {
            if (r.matchToken("take")) {
                let u = null;
                let l = [];
                while(u = e.parseElement("classRef", r))l.push(u);
                var n = null;
                var i = null;
                let c = l.length > 0;
                if (!c) {
                    n = e.parseElement("attributeRef", r);
                    if (n == null) e.raiseParseError(r, "Expected either a class reference or attribute expression");
                    if (r.matchToken("with")) i = e.requireElement("expression", r);
                }
                if (r.matchToken("from")) var a = e.requireElement("expression", r);
                if (r.matchToken("for")) var o = e.requireElement("expression", r);
                else var o = e.requireElement("implicitMeTarget", r);
                if (c) {
                    var s = {
                        classRefs: l,
                        from: a,
                        ...
                        op: function(e, r, n, i) {
                            ...
                            t.implicitLoop(r, function(e) {
                                var r = e.className;
                                if (n) t.implicitLoop(n, function(e) {
                                    e.classList.remove(r);
                                });
                                else t.implicitLoop(e, function(e) {
                                    e.classList.remove(r);
                                });
                    ...
                    var s = {
                        ...
                        op: function(e, r, i, s) {
                            ...
                            t.nullCheck(i, o);
                            t.implicitLoop(r, function(e) {
                                if (!s) e.removeAttribute(n.name);
                                else e.setAttribute(n.name, s);
                            });
                            t.implicitLoop(i, function(e) {
        ...
        function a(t, r, n, i) {
            if (n != null) var a = t.resolveSymbol(n, r);
            else var a = r;
            if (a instanceof Element || a instanceof HTMLDocument) {
                ...
                if (n != null) t.setSymbol(n, r, null, i);
        ...
        e.addCommand("put", function(e, t, r) {
            if (r.matchToken("put")) {
                ...
                if (i == null) e.raiseParseError(r, "Expected one of 'into', 'before', 'at start of', 'at end of', 'after'");
                var o = e.requireElement("expression", r);
                var s = i.value;
                var u = false;
                var l = false;
                ...
                var h = {
                    ...
                    op: function(e, r, n, i) {
                        if (l) a(t, e, n, i);
                            ...
                            t.nullCheck(r, c);
                            if (s === "into") {
                                if (m) t.implicitLoop(r, function(e) {
                                    e.setAttribute(n, i);
                                });
                                else if (p) t.implicitLoop(r, function(e) {
                                    e.style[n] = i;
                                });
                                else if (u) r[n] = i;
                                else t.implicitLoop(r, function(e) {
                                ...
                                t.implicitLoop(r, function(e) {
                                    ...
                                    if (e.parentElement) t.processNode(e.parentElement);
                                    else t.processNode(e);
                                });
                            }
                        }
                        return t.findNext(this, e);
        ...
        e.addCommand("transition", function(e, t, n) {
            if (n.matchToken("transition")) {
                ...
                while(!e.commandBoundary(l) && l.value !== "over" && l.value !== "using"){
                    ...
                    } else a.push(e.requireElement("stringLike", n));
                    if (n.matchToken("from")) s.push(e.requireElement("expression", n));
                    else s.push(null);
                    n.requireToken("to");
                    if (n.matchToken("initial")) u.push({
                        type: "initial_literal",
                        evaluate: function() {
                            return "initial";
                        }
                    });
                    else u.push(e.requireElement("expression", n));
                    l = n.currentToken();
                }
                if (n.matchToken("over")) var c = e.requireElement("expression", n);
                else if (n.matchToken("using")) var f = e.requireElement("expression", n);
                var m = {
                    to: u,
                    args: [
                        i,
                    ...
                    op: function(e, n, a, o, s, u, l) {
                        ...
                        t.implicitLoop(n, function(e) {
                            var n = new Promise(function(n, i) {
                                ...
                                if (l) e.style.transition = "all " + l + "ms ease-in";
                                else if (u) e.style.transition = u;
                                else e.style.transition = r.defaultTransition;
                                ...
                                if (!f.initialStyles) f.initialStyles = p;
                                for(var h = 0; h < a.length; h++){
                                    var E = a[h];
                                    var T = o[h];
                                    if (T === "computed" || T == null) e.style[E] = p[E];
                                    else e.style[E] = T;
                                }
                                var y = false;
                                var k = false;
        ...
        e.addCommand("measure", function(e, t, r) {
            ...
            var n = o(e, t, r);
            var i = [];
            if (!e.commandBoundary(r.currentToken())) do i.push(r.matchTokenType("IDENTIFIER").value);
            while (r.matchOpToken(","));
            return {
                properties: i,
                args: [
        ...
        e.addLeafExpression("closestExpr", function(e, t, r) {
            if (r.matchToken("closest")) {
                if (r.matchToken("parent")) var n = true;
                var i = null;
                ...
                if (i == null) {
                    var o = e.requireElement("expression", r);
                    if (o.css == null) e.raiseParseError(r, "Expected a CSS expression");
                    else i = o.css;
                }
                    ...
                    op: function(e, r) {
                        if (r == null) return null;
                            ...
                            t.implicitLoop(r, function(t) {
                                if (n) e.push(t.parentElement ? t.parentElement.closest(i) : null);
                                else e.push(t.closest(i));
                            });
                            if (t.shouldAutoIterate(r)) return e;
                            else return e[0];
                        }
                    },
                    evaluate: function(e) {
        ...
        e.addCommand("go", function(e, t, r) {
            if (r.matchToken("go")) {
                if (r.matchToken("back")) var n = true;
                else {
                    r.matchToken("to");
                    if (r.matchToken("url")) {
                        ...
                        if (s) {
                            if (s.value === "top") m.block = "start";
                            else if (s.value === "bottom") m.block = "end";
                            else if (s.value === "middle") m.block = "center";
                        }
                        if (u) {
                            if (u.value === "left") m.inline = "start";
                            else if (u.value === "center") m.inline = "center";
                            else if (u.value === "right") m.inline = "end";
                        }
                        if (f) {
                            if (f.value === "smoothly") m.behavior = "smooth";
                            else if (f.value === "instantly") m.behavior = "instant";
                        }
                    }
                }
                var p = {
        ...
        r.conversions.dynamicResolvers.push(function(t, r) {
            if (!(t === "Values" || t.indexOf("Values:") === 0)) return;
            var n = t.split(":")[1];
            var i = {};
            ...
            if (n) {
                if (n === "JSON") return JSON.stringify(i);
                else if (n === "Form") return new URLSearchParams(i).toString();
                else throw "Unknown conversion: " + n;
            } else return i;
            function o(e) {
                var t = s(e);
            ...
            function s(e) {
                try {
                    ...
                    if (t.name == undefined || t.value == undefined) return undefined;
                    if (e.type == "radio" && e.checked == false) return undefined;
                    if (e.type == "checkbox") {
                        if (e.checked == false) t.value = undefined;
            ...
            var t = function(e) {
                ...
                if (e instanceof NodeList) {
                    ...
                    for(var n = 0; n < e.length; n++){
                        var i = e[n];
                        if (i instanceof HTMLElement) r += i.outerHTML;
                    }
                    return r;
                }
                if (e.toString) return e.toString();
    ...
    function w() {
        ...
        function n(e) {
            if (document.readyState !== "loading") setTimeout(e);
...
},{}]},["5ma9C","i4icR"], "i4icR", "parcelRequire7857")
