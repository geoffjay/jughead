...
((
  ...
  Object.defineProperty(newRequire, "root", {
    get: () => globalObject[parcelRequireName],
  });
        ...
        if (!parent || !parent.isParcelRequire) {
          ...
          if (HMR_USE_SSE) ws = new EventSource("/__parcel_hmr");
            ...
            try {
              ...
              const { workerData, parentPort } = module.bundle.root(
                "node:worker_threads",
              ) /*: any*/;
              if (
                workerData !== null &&
...
${frame.code}`;
        ...
        function hmrAccept(bundle /*: ParcelRequire */, id /*: string */) {
          ...
          if (cached && cached.hot && cached.hot._acceptCallbacks.length) {
            ...
            if (assetsToAlsoAccept.length) {
              const handled = assetsToAlsoAccept.every((a) =>
                hmrAcceptCheck(a[0], a[1]),
              );
      ...
      (require, module, exports, __globalThis) => {
        ...
        var htmx = (() => {
          ...
          const htmx = {
            ...
            /* Event processing */ /** @type {typeof onLoadHelper} */ onLoad:
              null,
            ...
            /* DOM manipulation helpers */ /** @type {typeof removeElement} */ remove:
              null,
            ...
            /* Extension entrypoints */ /** @type {typeof defineExtension} */ defineExtension:
              null,
          ...
          const VERB_SELECTOR = VERBS.map(
            (verb) => "[hx-" + verb + "], [data-hx-" + verb + "]",
          ).join(", ");
          //= ===================================================================
          // Utilities
          //= ===================================================================
           ...
           */ function parseInterval(str) {
            ...
            if (str.slice(-2) == "ms") interval = parseFloat(str.slice(0, -2));
              ...
              interval = parseFloat(str.slice(0, -1)) * 60000;
           ...
           */ function getClosestAttributeValue(elt, attributeName) {
            ...
            getClosestMatch(
              elt,
              (e) =>
                !!(closestAttr = getAttributeValueWithDisinheritance(
                  elt,
                  asElement(e),
                  attributeName,
                )),
           ...
           */ function makeFragment(response) {
            ...
            if (startTag === "html") {
              ...
              fragment =
                /** @type DocumentFragmentWithTitle */ new DocumentFragment();
           ...
           */ function toArray(arr) {
            const returnArr = [];
            if (arr)
              for (let i = 0; i < arr.length; i++) returnArr.push(arr[i]);
            return returnArr;
          }
          /**
           * @template T
           ...
           */ function mergeObjects(obj1, obj2) {
            for (const key in obj2)
              if (Object.hasOwn(obj2, key))
                // @ts-expect-error tsc doesn't seem to properly handle types merging
                obj1[key] = obj2[key];
            // @ts-expect-error tsc doesn't seem to properly handle types merging
            return obj1;
          }
           ...
           */ function internalEval(str) {
            return maybeEval(getDocument().body, () => eval(str));
          }
          /**
           ...
           */ function takeClassForElement(elt, clazz) {
            elt = resolveTarget(elt);
            forEach(elt.parentElement.children, (child) => {
           ...
           */ function querySelectorAllExt(elt, selector, global) {
            ...
            while (parts.length > 0) {
              ...
              if (selector.indexOf("closest ") === 0)
                item = closest(
                  asElement(elt),
                  normalizeSelector(selector.slice(8)),
                );
           ...
           * @param {boolean} global
           * @returns {Element}
           */ var scanForwardQuery = (start, match, global) => {
           ...
           * @param {boolean} global
           * @returns {Element}
           */ var scanBackwardsQuery = (start, match, global) => {
            const results = asParentNode(
              getRootNode(start, global),
            ).querySelectorAll(match);
           ...
           */ function findAttributeTargets(elt, attrName) {
            ...
            if (attrTarget) {
              if (attrTarget === "this")
                ...
                const shouldInherit = /(^|,)(\s*)inherit(\s*)($|,)/.test(
                  attrTarget,
                );
                if (shouldInherit) {
                  const eltToInheritFrom = asElement(
                    getClosestMatch(
                      ...
                      (parent) =>
                        parent !== elt &&
                        hasAttribute(asElement(parent), attrName),
                    ),
                  );
                  if (eltToInheritFrom)
                    result.push(
           ...
           */ function findThisElement(elt, attribute) {
            return asElement(
              getClosestMatch(
                elt,
                (elt) => getAttributeValue(asElement(elt), attribute) != null,
              ),
            );
          }
          /**
           ...
           */ function cloneAttributes(mergeTo, mergeFrom) {
            forEach(Array.from(mergeTo.attributes), (attr) => {
              if (
            ...
            forEach(mergeFrom.attributes, (attr) => {
          ...
          function restorePreservedElements() {
            ...
            if (pantry) {
              for (const preservedElt of [...pantry.children]) {
                ...
                // @ts-expect-error - use proposed moveBefore feature
           ...
           */ function handleAttributes(parentNode, fragment, settleInfo) {
            forEach(fragment.querySelectorAll("[id]"), (newNode) => {
           ...
           */ function deInitNode(element) {
            ...
            if (internalData.listenerInfos)
              forEach(internalData.listenerInfos, (info) => {
                if (info.on)
                  removeEventListenerImpl(info.on, info.trigger, info.listener);
              });
            deInitOnHandlers(element);
            forEach(Object.keys(internalData), (key) => {
           ...
           */ function swap(target, content, swapSpec, swapOptions) {
            ...
            let doSwap = () => {
              ...
              if (swapSpec.swapStyle === "textContent")
                ...
                if (swapOptions.historyRequest)
                  // @ts-expect-error fragment can be a parentNode Element
                  fragment =
            ...
            if (Object.hasOwn(swapSpec, "transition"))
            ...
            if (
              ...
              const settlePromise = new Promise((_resolve, _reject) => {
              ...
              doSwap = () => {
                // @ts-expect-error experimental feature atm
                document.startViewTransition(() => {
                  innerDoSwap();
           ...
           */ function handleTriggerHeader(xhr, header, elt) {
            ...
            if (triggerBody.indexOf("{") === 0) {
              ...
              for (const eventName in triggers)
                if (Object.hasOwn(triggers, eventName)) {
           ...
           */ function maybeGenerateConditional(elt, tokens, paramName) {
            if (tokens[0] === "[") {
              ...
              while (tokens.length > 0) {
                ...
                // @ts-expect-error For some reason tsc doesn't understand the shift call, and thinks we're comparing the same value here, i.e. '[' vs ']'
                if (token === "]") {
                  bracketCount--;
                  if (bracketCount === 0) {
                    if (last === null)
           ...
           */ function processPolling(elt, handler, spec) {
            ...
            nodeData.timeout = getWindow().setTimeout(() => {
           ...
           */ function boostElement(elt, nodeData, triggerSpecs) {
            if (
              ...
              if (elt.tagName === "A") {
                ...
                verb = /** @type HttpVerb */ rawAttribute
                  ? rawAttribute.toLowerCase()
                  : "get";
              ...
              triggerSpecs.forEach((triggerSpec) => {
                addEventListener(
                  elt,
                  (node, evt) => {
           ...
           */ function shouldCancel(evt, elt) {
            if (evt.type === "submit" && elt.tagName === "FORM") return true;
              ...
              const btn =
                /** @type {HTMLButtonElement|HTMLInputElement|null} */ elt.closest(
           ...
           */ function addEventListener(
            ...
            if (triggerSpec.changed) {
              ...
              eltsToListenOn.forEach((eltToListenOn) => {
                ...
                // @ts-expect-error value will be undefined for non-input elements, which is fine
                elementData.lastValue
                  .get(triggerSpec)
                  .set(eltToListenOn, eltToListenOn.value);
              });
            }
            forEach(eltsToListenOn, (eltToListenOn) => {
              /** @type EventListener */ const eventListener = (evt) => {
                if (!bodyContains(elt)) {
           ...
           */ function processVerbs(elt, nodeData, triggerSpecs) {
            ...
            forEach(VERBS, (verb) => {
              if (hasAttribute(elt, "hx-" + verb)) {
                ...
                nodeData.verb = verb;
                triggerSpecs.forEach((triggerSpec) => {
                  addTriggerHandler(elt, triggerSpec, nodeData, (node, evt) => {
                    const elt = asElement(node);
                    if (eltIsDisabled(elt)) {
                      cleanUpElement(elt);
                      return;
           ...
           */ function getTargetButton(target) {
            return /** @type {HTMLButtonElement|HTMLInputElement|null} */ closest(
              asElement(target),
           ...
           */ function getRelatedForm(elt) {
            // @ts-expect-error Get the related form if available, else find the closest parent form
           ...
           */ function addHxOnEventHandler(elt, eventName, code) {
            ...
            let func;
            /** @type EventListener */ const listener = (e) => {
              maybeEval(elt, () => {
            ...
            if (!hasExplicitHttpAction) {
              if (getClosestAttributeValue(elt, "hx-boost") === "true")
                ...
                triggerSpecs.forEach((triggerSpec) => {
                  ...
                  addTriggerHandler(elt, triggerSpec, nodeData, () => {});
                });
            }
            // Handle submit buttons/inputs that have the form attribute set
            // see https://developer.mozilla.org/docs/Web/HTML/Element/button
           ...
           */ function processNode(elt) {
            ...
            forEach(findElementsToProcess(elt), (child) => {
           ...
           */ function withExtensions(elt, toDo, extensionsToIgnore) {
            forEach(getExtensions(elt, [], extensionsToIgnore), (extension) => {
              try {
                toDo(extension);
              } catch (e) {
                logError(e);
           ...
           */ function triggerEvent(elt, eventName, detail) {
            ...
            withExtensions(asElement(elt), (extension) => {
              eventResult =
                eventResult &&
           ...
           */ function cleanInnerHtmlForHistory(elt) {
            ...
            forEach(findAll(clone, "." + className), (child) => {
              removeClassFromElement(child, className);
            });
            // remove the disabled attribute for any element disabled due to an htmx request
            forEach(findAll(clone, "[data-disabled-by-htmx]"), (child) => {
           ...
           */ function restoreHistory(path) {
            ...
            } else if (htmx.config.refreshOnHistoryMiss)
              // @ts-expect-error: optional parameter in reload() function throws error
           ...
           */ function disableElements(elt) {
            ...
            forEach(disabledElts, (disabledElement) => {
           ...
           */ function removeRequestIndicators(indicators, disabled) {
            forEach(indicators.concat(disabled), (ele) => {
            ...
            forEach(disabled, (disabledElement) => {
              const internalData = getInternalData(disabledElement);
              if (
                internalData.requestCount === 0 &&
           ...
           * @param {FormData} formData */ function addValueToFormData(
            name,
            value,
            formData,
          ) {
           ...
           * @param {FormData} formData */ function removeValueFromFormData(
            name,
            value,
            formData,
          ) {
           ...
           */ function getValueFromInput(elt) {
            if (elt instanceof HTMLSelectElement && elt.multiple)
              return toArray(elt.querySelectorAll("option:checked")).map(
                (e) => e.value,
              );
            // include file inputs
           ...
           */ function processInputValue(
            ...
            if (elt instanceof HTMLFormElement) {
              ...
              new FormData(elt).forEach((value, name) => {
           ...
           */ function filterValues(inputValues, elt) {
            ...
            if (paramsValue) {
              if (paramsValue === "none") return new FormData();
                ...
                forEach(paramsValue.slice(4).split(","), (name) => {
                  name = name.trim();
                ...
                forEach(paramsValue.split(","), (name) => {
                  name = name.trim();
                  if (inputValues.has(name))
                    inputValues.getAll(name).forEach((value) => {
           ...
           */ function updateScrollState(content, swapSpec) {
            ...
            if (swapSpec.show) {
              ...
              if (swapSpec.show === "top" && (first || target)) {
                target = target || first;
                // @ts-expect-error For some reason tsc doesn't recognize "instant" as a valid option for now
           ...
           */ function getValuesForElement(
            ...
            if (attributeValue) {
              ...
              for (const key in varsValues) {
                if (Object.hasOwn(varsValues, key)) {
           ...
           */ function formDataProxy(formData) {
            return new Proxy(formData, {
              ...
              ownKeys: (target) => Reflect.ownKeys(Object.fromEntries(target)),
           ...
           */ function issueAjaxRequest(
            ...
            if (confirmed === undefined) {
              const issueRequest = (skipConfirmation) =>
                issueAjaxRequest(
                  verb,
                  path,
                  elt,
            ...
            const expressionVars = formDataFromObject(
              getExpressionVars(elt, event),
            );
             ...
             */ const requestAttrValues = getValuesForElement(
              elt,
              "hx-request",
            );
           ...
           */ function resolveResponseHandling(xhr) {
            for (var i = 0; i < htmx.config.responseHandling.length; i++) {
              /** @type HtmxResponseHandlingConfig */ var responseHandlingElement =
                htmx.config.responseHandling[i];
           ...
           */ function handleAjaxResponse(elt, responseInfo) {
            ...
            /** @type HtmxBeforeSwapDetails */ var beforeSwapDetails =
              mergeObjects(
                {
                  shouldSwap,
                  serverResponse,
            ...
            if (beforeSwapDetails.shouldSwap) {
              ...
              if (!Object.hasOwn(swapSpec, "ignoreTitle"))
           ...
           */ function extensionBase() {
            return {
              init: (api) => null,
              getSelectors: () => null,
              onEvent: (name, evt) => true,
              transformResponse: (text, xhr, elt) => text,
              isInlineSwap: (swapStyle) => false,
              handleSwap: (swapStyle, target, fragment, settleInfo) => false,
              encodeParameters: (xhr, parameters, elt) => null,
            };
          }
          /**
           ...
           */ function getExtensions(
            ...
            if (extensionsForElement)
              forEach(extensionsForElement.split(","), (extensionName) => {
          ...
          function getMetaConfig() {
            /** @type HTMLMetaElement */ const element =
              getDocument().querySelector('meta[name="htmx-config"]');
    ...
    "5oERU": [
      (require, module, exports, __globalThis) => {
        exports.interopDefault = (a) =>
          a && a.__esModule
            ? a
            : {
                default: a,
              };
        exports.defineInteropFlag = (a) => {
          Object.defineProperty(a, "__esModule", {
            value: true,
          });
        };
        exports.exportAll = (source, dest) => {
        ...
        exports.export = (dest, destName, get) => {
        ...
        (() => {
          ...
          var Tokens = class {
            ...
            toString() {
              ...
              var out = "Tokens(";
              out +=
                this.#consumed.filter((t) => t.type !== "WHITESPACE").length +
                " consumed, ";
              out +=
                this.#tokens.filter((t) => t.type !== "WHITESPACE").length +
                " remaining";
              out += ", line " + (lineIdx + 1) + ")\n";
              out +=
                "  " +
                String(lineIdx + 1).padStart(gutter) +
                " | " +
                contextLine +
                "\n";
              out +=
                " ".repeat(gutter + 5) + " ".repeat(col) + "^".repeat(tokenLen);
            ...
            matchTokenType(...types) {
              if (
                ...
                types.includes(this.currentToken().type)
              )
                return this.consumeToken();
            }
          ...
          var Tokenizer = class _Tokenizer {
            ...
            #consumeComment() {
              while (
                this.#currentChar() &&
                !this.#isNewline(this.#currentChar())
              )
                this.#consumeChar();
              this.#consumeChar();
            }
            ...
            #consumeClassReference() {
              ...
              if (this.#currentChar() === "{") {
                ...
                while (
                  this.#isValidCSSChar(this.#currentChar()) ||
                  this.#currentChar() === "\\"
                ) {
            ...
            #consumeOp() {
              ...
              while (
                this.#currentChar() &&
                OP_TABLE[value + this.#currentChar()]
              )
                value += this.#consumeChar();
            ...
            #tokenize() {
              while (this.#position < this.#source.length) {
                if (this.#isLineComment()) this.#consumeComment();
                  ...
                  this.#inTemplate() ||
                  this.#isReservedChar(this.#currentChar())
                )
                  this.#tokens.push(
                    this.#makeToken("RESERVED", this.#consumeChar()),
                  );
                else {
                  if (this.#position < this.#source.length)
                    throw new Error(
                      "Unknown token: " + this.#currentChar() + " ",
                    );
                }
              }
          ...
          var BooleanLiteral = class _BooleanLiteral extends Expression {
            ...
            static parse(parser) {
              var booleanLiteral =
                parser.matchToken("true") || parser.matchToken("false");
          ...
          var ObjectKey = class _ObjectKey extends Expression {
            ...
            static parse(parser) {
              ...
              if ((token = parser.matchTokenType("STRING")))
                ...
                do {
                  token =
                    parser.matchTokenType("IDENTIFIER") ||
                    parser.matchOpToken("-");
          ...
          var Parser = class _Parser {
            ...
            static formatErrors(errors) {
              ...
              var sortedLines = [...byLine.entries()].sort(
                (a, b) => a[0] - b[0],
              );
              var prevLineIdx = -1;
              var out = "";
              for (var [lineIdx, lineErrors] of sortedLines) {
                ...
                for (var e of lineErrors) {
                  var col = e.token?.line
                    ? e.token.column
                    : Math.max(0, contextLine.length - 1);
          ...
          var LanguageKernel = class {
            ...
            constructor() {
              ...
              this.addGrammarElement(
                "commandList",
                this.parseCommandList.bind(this),
              );
            ...
            parseFeature(parser) {
              ...
              var featureDefinition =
                this.#features[parser.currentToken().value || ""];
            ...
            parseCommand(parser) {
              ...
              var commandDefinition =
                this.#commands[parser.currentToken().value || ""];
              let commandElement;
            ...
            parseUnaryExpression(parser) {
              ...
              if (result)
                return this.parseElement("indirectExpression", parser, result);
            ...
            parseAssignableExpression(parser) {
              ...
              if (
                checkExpr &&
                this.#assignableExpressions.includes(checkExpr.type)
              )
                return expr;
              else
                parser.raiseError(
                  "A target expression must be writable.  The expression type '" +
                    (checkExpr && checkExpr.type) +
                    "' is not.",
                );
            }
            ...
            parsePrimaryExpression(parser) {
              ...
              parser.raiseError(
                "Unexpected value: " + parser.currentToken().value,
              );
            }
            ...
            addCommands(...commandClasses) {
              for (const CommandClass of commandClasses) {
                if (!CommandClass.keyword)
                  throw new Error(
                    `Command class ${CommandClass.name} must have a static 'keyword' property`,
                  );
                if (!CommandClass.parse)
                  throw new Error(
                    `Command class ${CommandClass.name} must have a static 'parse' method`,
                  );
                var keywords = Array.isArray(CommandClass.keyword)
                  ? CommandClass.keyword
                  : [CommandClass.keyword];
                for (var kw of keywords)
                  this.addCommand(kw, CommandClass.parse);
              }
            }
            addFeatures(...featureClasses) {
              for (const FeatureClass of featureClasses) {
                if (!FeatureClass.keyword)
                  throw new Error(
                    `Feature class ${FeatureClass.name} must have a static 'keyword' property`,
                  );
                if (!FeatureClass.parse)
                  throw new Error(
                    `Feature class ${FeatureClass.name} must have a static 'parse' method`,
                  );
             ...
             */ registerParseElement(ElementClass) {
              ...
              if (
                ...
                ElementClass.prototype instanceof Command
              ) {
                var keywords = Array.isArray(ElementClass.keyword)
                  ? ElementClass.keyword
                  : [ElementClass.keyword];
              ...
              if (
                ElementClass.keyword &&
                ElementClass.prototype instanceof Feature
              ) {
                var keywords = Array.isArray(ElementClass.keyword)
                  ? ElementClass.keyword
                  : [ElementClass.keyword];
          ...
          var HyperscriptFormData = class {
            ...
            addElement(node) {
              ...
              if (this.result[name] == void 0) this.result[name] = value;
                ...
                var existing = Array.isArray(this.result[name])
                  ? this.result[name]
                  : [this.result[name]];
            ...
            addContainer(node) {
              ...
              if (node.querySelectorAll)
                node
                  ...
                  .forEach((child) => this.addElement(child));
            }
          };
          ...
          var conversions = {
            dynamicResolvers: [
              ...
              (str, node, runtime2) => {
                ...
                runtime2.implicitLoop(node, (node2) =>
                  formData.addContainer(node2),
                );
            ...
            Array: (val) => Array.from(val),
            JSON: (val) => {
              if (typeof Response !== "undefined" && val instanceof Response)
                return val.json();
              return JSON.parse(val);
            },
            JSONString: (val) => JSON.stringify(val),
            Object: (val) => {
              if (val instanceof String) val = val.toString();
              if (typeof val === "string") return JSON.parse(val);
              else return Object.assign({}, val);
            },
            FormEncoded: (val) => new URLSearchParams(val).toString(),
            Set: (val) => new Set(val),
            Map: (val) => new Map(Object.entries(val)),
            Keys: (val) => {
            ...
            Reversed: (val) => Array.from(val).reverse(),
            Unique: (val) => [...new Set(val)],
            Flat: (val) => Array.from(val).flat(),
            HTML: _toHTML,
            Stream: () => {
              throw new Error(
            ...
            set(target, prop, value) {
              ...
              if (typeof value === "string") {
                ...
                if (value.partitioned)
                  parts.push("partitioned=" + value.partitioned);
          ...
          var ElementCollection = class {
            ...
            [Symbol.iterator]() {
              const query = this.selectMatches();
              return query[Symbol.iterator]();
            }
            selectMatches() {
              const query = this._runtime
          ...
          var TemplatedQueryElementCollection = class extends ElementCollection {
            constructor(css, relativeToElement, templateParts, runtime2) {
              ...
              this.elements = templateParts.filter(
          ...
          var RegExpIterable = class {
            ...
            [Symbol.iterator]() {
              return new RegExpIterator(
                new RegExp(this.re, this.flags),
                this.str,
              );
            }
          };
          ...
          var Runtime = class _Runtime {
            ...
            unifiedEval(parseElement, ctx) {
              ...
              if (parseElement.args)
                for (var [name, argument] of Object.entries(
                  parseElement.args,
                )) {
            ...
            resolveSymbol(str, context, type, targetElement) {
              ...
              if (type === "element") {
                if (this.reactivity.isTracking)
                  this.reactivity.trackElementSymbol(str, context.meta.owner);
                var val = this.#getElementScope(context)[str];
                this.#trackMutation(val);
                return val;
              }
              if (type === "inherited") {
                var inherited = this.#resolveInherited(
                  str,
                  context,
                  targetElement,
                );
                if (this.reactivity.isTracking) {
                  var trackElement =
                    inherited.element || targetElement || context.meta?.owner;
                  if (trackElement)
            ...
            setSymbol(str, context, type, value, targetElement) {
              ...
              if (type === "inherited") {
                ...
                if (inherited.element) {
                  this.getInternalData(inherited.element).elementScope[str] =
                    value;
            ...
            #resolveInherited(str, context, startElement) {
              ...
              while (elt) {
                ...
                if (
                  internalData &&
                  internalData.elementScope &&
                  str in internalData.elementScope
                )
                  return {
                ...
                var domScope =
                  elt.getAttribute && elt.getAttribute("dom-scope");
                if (domScope) {
                  ...
                  if (match) {
                    elt =
                      elt.parentElement && elt.parentElement.closest(match[1]);
                    continue;
                  }
            ...
            resolveProperty(root, property) {
              if (this.reactivity.isTracking)
                this.reactivity.trackProperty(root, property);
              return this.#flatGet(
                root,
                property,
                (root2, property2) => root2[property2],
              );
            }
            /**
            ...
            resolveAttribute(root, property) {
              if (this.reactivity.isTracking)
                this.reactivity.trackAttribute(root, property);
              return this.#flatGet(
                root,
                property,
                (root2, property2) =>
                  root2.getAttribute && root2.getAttribute(property2),
              );
            }
            resolveStyle(root, property) {
              return this.#flatGet(
                root,
                property,
                (root2, property2) => root2.style && root2.style[property2],
              );
            }
            resolveComputedStyle(root, property) {
              return this.#flatGet(root, property, (root2, property2) =>
                getComputedStyle(root2).getPropertyValue(property2),
              );
            }
            assignToNamespace(elt, nameSpace, name, value) {
              ...
              if (
                elt == null ||
                (typeof document !== "undefined" && elt === document.body)
              )
            ...
            shouldAutoIterate(value) {
              return (
                (value != null && value[SHOULD_AUTO_ITERATE_SYM]) ||
            ...
            forEach(value, func) {
              if (value == null);
                ...
                for (const nth of value) func(nth);
              else if (this.#isArrayLike(value))
                for (var i = 0; i < value.length; i++) func(value[i]);
              else func(value);
            }
             ...
             */ implicitLoopWhen(
              ...
              var elements = [];
              this.implicitLoop(targets, (elt) => {
                elements.push(elt);
              });
              var conditions = elements.map((elt) => {
                context.beingTested = elt;
                return whenExpr.evaluate(context);
              });
              context.beingTested = null;
              var hasPromise = conditions.some(
                (c) => c && typeof c.then === "function",
              );
              if (hasPromise)
                return Promise.all(conditions).then((results) => {
                  context.result = this.#applyWhenResults(
                    elements,
                    results,
                    forwardFn,
                    reverseFn,
            ...
            typeCheck(value, typeString, nullOk) {
              ...
              var ctor =
                typeof globalThis !== "undefined" && globalThis[typeString];
            ...
            escapeSelector(str) {
              return str.replace(/[:&()[\]/]/g, (str2) => "\\" + str2);
            }
            getEventQueueFor(elt, onFeature) {
              const internalData = this.getInternalData(elt);
            ...
            #getScriptAttributes() {
              if (this.#scriptAttrs == null)
                this.#scriptAttrs = config.attributes
                  .replaceAll(" ", "")
                  .split(",");
            ...
            #getScriptSelector() {
              if (!this.#scriptSelector)
                this.#scriptSelector = this.#getScriptAttributes()
                  .map((a) => "[" + a + "]")
                  .join(", ");
            ...
            cleanup(elt) {
              ...
              if (data.observers)
                for (var observer of data.observers) observer.disconnect();
              if (data.eventState) {
              ...
              if (elt.querySelectorAll)
                for (var child of elt.querySelectorAll(
            ...
            #resolveTemplateScopes(elt) {
              var root = elt.closest(
                '[data-live-template], [dom-scope="isolated"]',
              );
              ...
              for (var i = 0; i < matches.length; i++) {
                ...
                if (!scope) continue;
                internalData.elementScope[scope.identifier] =
                  scope.source[iter];
              ...
              if (elt.querySelectorAll)
                this.forEach(
                  ...
                  (elt2) => {
                    this.#initElement(
                      elt2,
                      elt2 instanceof HTMLScriptElement &&
                        elt2.type === "text/hyperscript"
                        ? document.body
                        : elt2,
                    );
                  },
            ...
            beepValueToConsole(element, expression, value) {
              if (
                ...
                var typeName = !value
                  ? "object (null)"
                  : value instanceof ElementCollection
                    ? "ElementCollection"
                ...
                console.log(
                  "///_ BEEP! The expression (" +
                    expression.sourceFor().replace("beep! ", "") +
                    ") evaluates to:",
                  logValue,
                  "of type " + typeName,
                );
          ...
          var Reactivity = class {
             ...
             */ trackProperty(obj, name) {
              if (obj == null || typeof obj !== "object" || obj._hsSkipTracking)
                return;
              this._currentEffect.dependencies.set(
             ...
             */ _subscribeEffect(effect) {
              for (var [depKey, dep] of effect.dependencies) {
                if (dep.type === "symbol" && dep.scope === "global") {
                  ...
                  this._subscribeAttributeDependency(
                    dep.element,
                    dep.name,
                    effect,
                  );
                else if (dep.type === "property")
                  this._subscribePropertyDependency(
                    dep.object,
                    dep.name,
                    effect,
                  );
             ...
             */ _subscribeAttributeDependency(element, attrName, effect) {
              ...
              if (!state.attributeObservers[attrName]) {
                ...
                var observer = new MutationObserver(() => {
                  for (var eff of trackedEffects) this._scheduleEffect(eff);
                });
             ...
             */ _cleanupOrphanedDeps(deps) {
              for (var [depKey, dep] of deps) {
                if (dep.type === "attribute" && dep.element) {
                  ...
                  if (
                    state.propertyHandler &&
                    state.propertyHandler.effects.size === 0
                  ) {
            ...
            /** Stop all reactive effects owned by an element. */ stopElementEffects(
              element,
            ) {
          ...
          var Morph = class {
             ...
             */ morph(oldNode, content, callbacks = {}) {
              ...
              if (
                newRoot &&
                !newRoot.nextElementSibling &&
                newRoot.tagName === oldNode.tagName
              ) {
          ...
          function _morphChildren(
            ...
            while (newChild) {
                  ...
                  while (cursor && cursor !== matchedNode) {
                    ...
                    if (
                      ...
                      (ctx.idMap.has(tempNode) ||
                        _matchesUpcomingSibling(ctx, tempNode, newChild))
                    )
              ...
              if (
                ...
                const escapedId = CSS.escape(newChild.id);
                matchedNode =
                ...
                while ((element = element.parentNode)) {
                  const idSet = ctx.idMap.get(element);
                  if (idSet) {
              ...
              if (ctx.idMap.has(newChild)) {
                const placeholder = document.createElement(newChild.tagName);
          ...
          function _findBestMatch(ctx, node, startPoint, endPoint) {
            ...
            if (softMatch && _matchesUpcomingSibling(ctx, softMatch, node))
              return null;
            return softMatch;
          }
          function _matchesUpcomingSibling(ctx, oldElt, startNode) {
            ...
            for (
              var sibling = startNode.nextSibling, i = 0;
              sibling && i < 10;
          ...
          function _createIdMaps(oldNode, newContent) {
            ...
            var persistentIds = _createPersistentIds(
              oldIdElements,
              newIdElements,
            );
            var idMap = /* @__PURE__ */ new Map();
            _populateIdMapWithTree(
              idMap,
              persistentIds,
          ...
          function _createPersistentIds(oldIdElements, newIdElements) {
            var duplicateIds = /* @__PURE__ */ new Set(),
              oldIdTagNameMap = /* @__PURE__ */ new Map();
          ...
          var HtmxCompat = class _HtmxCompat {
            ...
            init() {
              ...
              globalScope2.document.addEventListener("htmx:load", (evt) => {
                this.#processingFromHtmx = true;
                _hyperscript2.process(evt.detail.elt);
                this.#processingFromHtmx = false;
              });
              globalScope2.document.addEventListener(
                "htmx:after:process",
                (evt) => {
                  this.#processingFromHtmx = true;
              ...
              if (typeof htmx !== "undefined") {
                _hyperscript2.addAfterProcessHook((elt) => {
                  if (!this.#processingFromHtmx) htmx.process(elt);
                });
                if (htmx.version?.startsWith("4"))
                  htmx.registerExtension("hs-include", {
                    htmx_config_request: (elt, detail) => {
                      ...
                      if (!found) return;
                      var vars = _HtmxCompat.#resolveSpecifiers(
                        found.value,
                        found.scopeElt,
                      );
            ...
            static #resolveSpecifiers(attrValue, scopeElt) {
              ...
              if (raw === "*") {
                var scope = _HtmxCompat.#readScope(scopeElt);
                for (var k in scope)
                  if (Object.hasOwn(scope, k))
                    result[k[0] === ":" ? k.slice(1) : k] =
                      _HtmxCompat.#serialize(scope[k]);
                return result;
              }
              var self2 = _HtmxCompat;
              raw.split(",").forEach((part) => {
                ...
                if (part[0] === ":") {
                  ...
                  var scopeKey = ":" + name;
                  if (scopeKey in scope2)
                    result[name] = self2.#serialize(scope2[scopeKey]);
                } else if (part[0] === "^") {
                  var name = part.slice(1);
          ...
          var SymbolRef = class _SymbolRef extends Expression {
            ...
            static parse(parser) {
              ...
              const eltPrefix = parser.matchOpToken(":");
              const caretPrefix = !eltPrefix && parser.matchOpToken("^");
              const identifier = parser.matchTokenType("IDENTIFIER");
              if (identifier && identifier.value) {
                ...
                if (scope === "inherited" && parser.matchToken("on")) {
                  var follows = parser.pushFollows(
                    "to",
                    "into",
                    "before",
                    "after",
          ...
          var BeepExpression = class _BeepExpression extends Expression {
            ...
            resolve(ctx, { value }) {
              ctx.meta.runtime.beepValueToConsole(
                ctx.me,
                this.expression,
                value,
              );
          ...
          var PropertyAccess = class _PropertyAccess extends Expression {
            ...
            resolve(context, { root: rootVal }) {
              return context.meta.runtime.resolveProperty(
                rootVal,
                this.prop.value,
              );
            }
          ...
          var OfExpression = class _OfExpression extends Expression {
            ...
            resolve(context, { root: rootVal }) {
              if (this._isAttribute)
                return context.meta.runtime.resolveAttribute(
                  rootVal,
                  this._prop,
                );
              else if (this._isComputed)
                return context.meta.runtime.resolveComputedStyle(
                  rootVal,
                  this._prop,
                );
            ...
            set(ctx, lhs, value) {
              ...
              if (this._isAttribute)
                ctx.meta.runtime.implicitLoop(lhs.root, (elt) => {
                  value == null
                    ? elt.removeAttribute(this._prop)
                    : elt.setAttribute(this._prop, value);
                });
              else if (this._isStyle)
                ctx.meta.runtime.implicitLoop(lhs.root, (elt) => {
              ...
              if (
                ...
                (root.type === "symbol" &&
                  (root.name === "my" ||
                    root.name === "its" ||
                    root.name === "your") &&
                  (parser.currentToken().type === "IDENTIFIER" ||
                    parser.currentToken().type === "ATTRIBUTE_REF" ||
                    parser.currentToken().type === "STYLE_REF"))
              ) {
                ...
                var propertyAccess = new _PossessiveExpression(
                  root,
                  attribute || style,
                  prop,
                );
            ...
            resolve(context, { root: rootVal }) {
              ...
              if (this.attribute) {
                if (this.attribute.type === "computedStyleRef")
                  value = context.meta.runtime.resolveComputedStyle(
                    rootVal,
                    this.attribute["name"],
                  );
                else if (this.attribute.type === "styleRef")
                  value = context.meta.runtime.resolveStyle(
                    rootVal,
                    this.attribute["name"],
                  );
                else
                  value = context.meta.runtime.resolveAttribute(
                    rootVal,
                    this.attribute.name,
                  );
              } else
                value = context.meta.runtime.resolveProperty(
                  rootVal,
                  this.prop.value,
                );
              return value;
          ...
          var InExpression = class _InExpression extends Expression {
            ...
            resolve(context, { root: rootVal, target }) {
              ...
              var returnArr = [];
              if (rootVal.css)
                context.meta.runtime.implicitLoop(target, (targetElt) => {
                ...
                context.meta.runtime.implicitLoop(rootVal, (rootElt) => {
                  context.meta.runtime.implicitLoop(target, (targetElt) => {
          ...
          var AsExpression = class _AsExpression extends Expression {
            ...
            resolve(context, { root: rootVal }) {
              return context.meta.runtime.convertValue(
                rootVal,
                this.conversion,
              );
            }
          ...
          var FunctionCall = class _FunctionCall extends Expression {
            ...
            static parse(parser, root) {
              ...
              var functionCall;
              if (root.root)
                functionCall = new _FunctionCall(
                  root,
                  args,
                  {
                    target: root.root,
          ...
          var AttributeRefAccess = class _AttributeRefAccess extends Expression {
            ...
            resolve(_ctx, { root: rootVal }) {
              return _ctx.meta.runtime.resolveAttribute(
                rootVal,
                this.attribute.name,
              );
            }
            ...
            set(ctx, lhs, value) {
              ...
              ctx.meta.runtime.implicitLoop(lhs.root, (elt) => {
                value == null
                  ? elt.removeAttribute(this.attribute.name)
                  : elt.setAttribute(this.attribute.name, value);
              });
            }
          };
          var ArrayIndex = class _ArrayIndex extends Expression {
            ...
            static parse(parser, root) {
              ...
              parser.requireOpToken("]");
              var arrayIndex = new _ArrayIndex(
                root,
                firstIndex,
                secondIndex,
                andBefore,
          ...
          var MathOperator = class _MathOperator extends Expression {
            ...
            static parse(parser) {
              ...
              var mathOp,
                initialMathOp = null;
              mathOp =
                parser.matchAnyOpToken("+", "-", "*", "/") ||
                parser.matchToken("mod");
              while (mathOp) {
          ...
          var ComparisonOperator = class _ComparisonOperator extends Expression {
            ...
            static parse(parser) {
              ...
              if (operator == null) {
                if (parser.matchToken("is") || parser.matchToken("am")) {
                  ...
                  parser.matchToken("exist") ||
                  parser.matchToken("exists")
                ) {
                  operator = "exist";
                  hasRightValue = false;
                } else if (
                  parser.matchToken("matches") ||
                  parser.matchToken("match")
                )
                  operator = "match";
                else if (
                  parser.matchToken("contains") ||
                  parser.matchToken("contain")
                )
                  operator = "contain";
                else if (
                  parser.matchToken("includes") ||
                  parser.matchToken("include")
                )
                  operator = "include";
                  ...
                  parser.matchToken("precedes") ||
                  parser.matchToken("precede")
                )
                  operator = "precede";
                else if (
                  parser.matchToken("follows") ||
                  parser.matchToken("follow")
                )
                  operator = "follow";
            ...
            resolve(context, { lhs: lhsVal, rhs: rhsVal, rhs2: rhs2Val }) {
              ...
              if (operator === "match")
                return (
                  lhsVal != null && this.sloppyMatches(lhs, lhsVal, rhsVal)
                );
              ...
              if (operator === "in")
                return (
                  rhsVal != null && this.sloppyContains(rhs, rhsVal, lhsVal)
                );
              if (operator === "not in")
                return (
                  rhsVal == null || !this.sloppyContains(rhs, rhsVal, lhsVal)
              ...
              if (operator === "contain" || operator === "include")
                return (
                  lhsVal != null && this.sloppyContains(lhs, lhsVal, rhsVal)
                );
              ...
              if (operator === "precede")
                return (
                  lhsVal != null &&
                  rhsVal != null &&
                  (lhsVal.compareDocumentPosition(rhsVal) &
                    Node.DOCUMENT_POSITION_FOLLOWING) !==
                    0
                );
              ...
              if (operator === "not exist")
                return !context.meta.runtime.doesExist(lhsVal);
              if (operator === "a")
                return context.meta.runtime.typeCheck(
                  lhsVal,
                  typeName.value,
                  nullOk,
                );
            ...
            static parse(parser) {
              ...
              while (changed) {
                ...
                if (parser.matchToken("where")) {
                  ...
                  parser.requireToken("to");
                  root = new MappedToExpression(
                    root,
                    this.parseOperand(parser),
                  );
                  changed = true;
          ...
          var SortedByExpression = class extends Expression {
            ...
            resolve(context, { root: collection }) {
              ...
              return indices.map((i2) => items[i2]);
            }
          };
          ...
          var DotOrColonPath = class extends Expression {
            ...
            static parse(parser) {
              ...
              if (root) {
                var path = [root.value];
                var separator =
                  parser.matchOpToken(".") || parser.matchOpToken(":");
                if (separator)
                  do
                    path.push(
                      parser.requireTokenType("IDENTIFIER", "NUMBER").value,
                    );
                  while (parser.matchOpToken(separator.value));
                return new DotOrColonPathNode(
                  path,
                  separator ? separator.value : null,
                );
              }
            }
          };
          ...
          var IdRef = class _IdRef extends Expression {
            ...
            resolve(context, { expr } = {}) {
              if (this.variant === "template")
                return context.meta.runtime
                  .getRootNode(context.me)
                  .getElementById(expr);
              else
                return context.meta.runtime
                  .getRootNode(context.me)
          ...
          var ClassRef = class _ClassRef extends Expression {
            ...
            constructor(variant, css, className, innerExpression) {
              ...
              this.variant = variant;
              this.type =
                variant === "template" ? "classRefTemplate" : "classRef";
              this.css = css;
          ...
          var AttributeRef = class _AttributeRef extends Expression {
            ...
            set(ctx, lhs, value) {
              ...
              if (target)
                value == null
                  ? target.removeAttribute(this.name)
                  : target.setAttribute(this.name, value);
            }
          };
          var StyleRef = class _StyleRef extends Expression {
            ...
            constructor(variant, name) {
              ...
              this.variant = variant;
              this.type =
                variant === "computed" ? "computedStyleRef" : "styleRef";
              this.name = name;
            }
            static parse(parser) {
              ...
              while (parser.hasMore()) {
                if (parser.matchOpToken("\\")) parser.consumeToken();
                  ...
                  stringParts[stringParts.length - 1] +=
                    parser.source.substring(tok.start, tok.end);
                }
          ...
          var StringPostfixExpression = class _StringPostfixExpression extends Expression {
            ...
            static parse(parser, root) {
              const stringPostfix =
                parser.matchAnyToken(...STRING_POSTFIXES) ||
                parser.matchOpToken("%");
          ...
          var TimeExpression = class _TimeExpression extends Expression {
            ...
            static parse(parser, root) {
              ...
              if (parser.matchToken("s") || parser.matchToken("seconds"))
                ...
                parser.matchToken("ms") ||
                parser.matchToken("milliseconds")
              )
                timeFactor = 1;
          ...
          var TypeCheckExpression = class _TypeCheckExpression extends Expression {
            ...
            resolve(context, { value: val }) {
              var passed = context.meta.runtime.typeCheck(
                val,
                this.typeName.value,
                this.nullOk,
              );
              if (passed) return val;
                ...
                throw new Error(
                  "Typecheck failed!  Expected: " + this.typeName.value,
                );
            }
          };
          ...
          var RelativePositionalExpression = class _RelativePositionalExpression extends Expression {
            ...
            scanForwardArray(start, array, match, wrap) {
              ...
              for (var elt of array)
                if (elt.matches(match) || elt === start) matches.push(elt);
              ...
              if (this.inSearch) {
                if (inElt) {
                  if (this.forwardSearch)
                    ...
                    return this.scanBackwardsArray(
                      from,
                      inElt,
                      css,
                      this.wrapping,
                ...
                if (this.forwardSearch)
                  ...
                  return this.scanBackwardsQuery(
                    from,
                    root,
                    css,
                    this.wrapping,
          ...
          var ClosestExprNode = class extends Expression {
            ...
            resolve(ctx, { to }) {
              ...
              ctx.meta.runtime.implicitLoop(to, (to2) => {
                if (parentSearch)
                  result.push(
                    to2.parentElement ? to2.parentElement.closest(css) : null,
                  );
                else result.push(to2.closest(css));
              });
              return ctx.meta.runtime.shouldAutoIterate(to)
                ? result
                : result[0];
            }
            get lhs() {
          ...
          var ClosestExpr = class extends Expression {
            ...
            static parse(parser) {
              ...
              if (parser.currentToken().type === "ATTRIBUTE_REF") {
                attributeRef = parser.requireElement(
                  "attributeRefAccess",
                  null,
                );
              ...
              var closestExpr = new ClosestExprNode(
                parentSearch,
                expr,
                css,
                to,
          ...
          var AppendCommand = class _AppendCommand extends Command {
            ...
            static parse(parser) {
              ...
              while (checkTarget.type === "parenthesized")
                checkTarget = checkTarget.expr;
          ...
          var PickCommand = class _PickCommand extends Command {
            ...
            static parsePickRange(parser) {
              ...
              rv.from = parser.matchToken("start")
                ? 0
            ...
            static parse(parser) {
              ...
              if (
                parser.matchToken("item") ||
                parser.matchToken("items") ||
                parser.matchToken("character") ||
                parser.matchToken("characters")
              ) {
                var follows = parser.pushFollows("of", "from");
                try {
          ...
          var FetchCommand = class _FetchCommand extends Command {
            ...
            static parseConversionInfo(parser) {
              ...
              parser.matchToken("a") || parser.matchToken("an");
              if (
                parser.matchToken("json") ||
                parser.matchToken("JSON") ||
                parser.matchToken("Object")
              )
                type = "json";
              else if (
                parser.matchToken("response") ||
                parser.matchToken("Response")
              )
                type = "response";
            ...
            static parse(parser) {
              ...
              var conversion = conversionInfo
                ? conversionInfo.conversion
                : null;
              return new _FetchCommand(
                url,
                argExprs,
                type,
                conversion,
            ...
            resolve(context, { url, options }) {
              ...
              context.meta.runtime.triggerEvent(
                context.me,
                "hyperscript:beforeFetch",
                detail,
              );
              context.meta.runtime.triggerEvent(
                context.me,
              ...
              var checkThrow =
                !this.dontThrow && this.conversionType !== "response";
              return fetch(url, detail)
                .then((resp) => {
                  ...
                  if (this.conversionType === "json")
                    return resp.json().then(complete);
                  if (this.conversion) {
                    var convFn = config.conversions[this.conversion];
                    if (convFn && convFn._rawResponse)
                      return complete(
                        convFn(resp, context.meta.runtime, context),
                      );
                  }
                  return resp.text().then((result) => {
                    if (this.conversion)
                      result = context.meta.runtime.convertValue(
                        result,
                        this.conversion,
                      );
                    if (this.conversionType === "html")
                      result = context.meta.runtime.convertValue(
                        result,
                        "Fragment",
                      );
          ...
          function _parseScrollModifiers(parser) {
            parser.matchToken("the");
            var verticalPosition = parser.matchAnyToken(
              "top",
              "middle",
              "bottom",
            );
            var horizontalPosition = parser.matchAnyToken(
              "left",
              "center",
              "right",
            );
            ...
            if (verticalPosition)
              scrollOptions.block = blockMap[verticalPosition.value];
            if (horizontalPosition)
              scrollOptions.inline = inlineMap[horizontalPosition.value];
            if (smoothness)
              scrollOptions.behavior = behaviorMap[smoothness.value];
            return {
              target,
              offset,
              plusOrMinus,
          ...
          function _resolveScroll(
            ...
            ctx.meta.runtime.implicitLoop(to, (target) => {
              ...
              if (plusOrMinus) {
                ...
                var offsetX =
                  ...
                  scrollOptions.inline == "end"
                    ...
                    : 0;
                var offsetY =
                  scrollOptions.block == "start" || scrollOptions.block == "end"
                    ? actualOffset
                    : 0;
          ...
          var ScrollCommand = class _ScrollCommand extends Command {
            ...
            static parse(parser) {
              ...
              var direction = parser.matchAnyToken(
                "up",
                "down",
                "left",
                "right",
            ...
            resolve(ctx, { target, offset, container }) {
              if (this.byMode) {
                ...
                if (this.scrollOptions.behavior)
                  opts.behavior = this.scrollOptions.behavior;
                el.scrollBy(opts);
              } else
                _resolveScroll(
                  ctx,
          ...
          var PutCommand = class _PutCommand extends Command {
            ...
            constructor(target, operation, value, rootExpr) {
              ...
              this.symbolWrite =
                target.type === "symbol" && operation === "into";
              this.arrayIndex = target.type === "arrayIndex";
              this.attributeWrite =
                (target.type === "attributeRef" ||
                  (target.attribute &&
                    target.attribute.type === "attributeRef")) &&
                operation === "into";
              this.styleWrite =
                (target.type === "styleRef" ||
            ...
            static parse(parser) {
              ...
              var value = parser.requireElement("expression");
              var operationToken = parser.matchAnyToken(
                "into",
                "before",
                "after",
              );
              ...
              if (this.symbolWrite)
                ...
                if (this.operation === "into") {
                  if (this.attributeWrite)
                    context.meta.runtime.implicitLoop(root, (elt) => {
                    ...
                    context.meta.runtime.implicitLoop(root, (elt) => {
                      this.putInto(context, elt, prop, valueToPut);
                    });
                  }
                  ...
                  context.meta.runtime.implicitLoop(root, (elt) => {
                    op.call(
                      ...
                      valueToPut instanceof Node
                        ? valueToPut
                        : context.meta.runtime.convertValue(
                            valueToPut,
                            "Fragment",
                          ),
                    );
                      ...
                      if (eventInfo.name && eventInfo.args)
                        for (const arg of eventInfo.args)
                          context.locals[arg.value] =
                            evt[arg.value] ||
                            (evt.detail ? evt.detail[arg.value] : null);
                      if (!resolved) {
                        resolved = true;
          ...
          var SendCommand = class _SendCommand extends Command {
            ...
            resolve(context, { to, eventName, details }) {
              ...
              context.meta.runtime.implicitLoop(to, (target) => {
                context.meta.runtime.triggerEvent(
                  target,
                  eventName,
                  details,
          ...
          var WaitATick = class extends Command {
            ...
            resolve(context) {
              return new Promise((resolve) => {
                setTimeout(
                  () => resolve(context.meta.runtime.findNext(this)),
                  0,
                );
              });
            }
          ...
          var RepeatLoopCommand = class extends Command {
            ...
            resolve(context, { whileValue, times }) {
              ...
              if (this.bottomTested && iteratorInfo.index === 0)
                ...
                if (this.event)
                  keepLooping =
                    context.meta.iterators[this.slot].eventFired === false;
                ...
                if (iteratorInfo.async) {
                  return iteratorInfo.iterator.next().then((result) => {
                    if (result.done)
                      return this._endLoop(context, iteratorInfo);
                    return this._continueLoop(
                      context,
                      iteratorInfo,
                      result.value,
                    );
            ...
            _continueLoop(context, iteratorInfo, loopVal) {
              ...
              if (context.meta.__ht_template_result && iteratorInfo.value) {
                var scopes =
                  context.meta.__ht_scopes || (context.meta.__ht_scopes = {});
                if (!scopes[this.slot])
                  scopes[this.slot] = {
          ...
          var IfCommand = class _IfCommand extends Command {
            ...
            static parse(parser) {
              ...
              const elseToken =
                parser.matchToken("else") || parser.matchToken("otherwise");
              if (elseToken) {
                const elseIfIfToken = parser.peekToken("if");
                nestedIfStmt =
                  elseIfIfToken != null &&
                  elseIfIfToken.line === elseToken.line;
                if (nestedIfStmt)
          ...
          var RepeatCommand = class _RepeatCommand extends Command {
            ...
            static parseRepeatExpression(parser, startedWithForToken) {
              ...
              const repeatLoopCommand = new RepeatLoopCommand(
                loopConfig,
                loop,
                elseBranch,
              );
              const repeatCommand = new _RepeatCommand(
                expression,
                evt,
                on,
                slot,
          ...
          var JsCommand = class _JsCommand extends Command {
            ...
            resolve(context) {
              var args = this.inputs.map((input) =>
                context.meta.runtime.resolveSymbol(input, context, "local"),
              );
              var result = this.function.apply(
                context.meta.runtime.globalScope,
                args,
              );
              if (result && typeof result.then === "function")
          ...
          var PseudoCommand = class _PseudoCommand extends Command {
            ...
            static parse(parser) {
              const lookAhead = parser.token(1);
              if (
                !(
                  lookAhead &&
                  lookAhead.op &&
          ...
          var HIDE_SHOW_STRATEGIES = {
            display: (op, element, arg, runtime2) => {
          ...
          function _removeCssProperties(elt, propNames) {
            for (var i = 0; i < propNames.length; i++)
              elt.style.removeProperty(propNames[i]);
          }
          ...
          var AddCommand = class _AddCommand extends Command {
            ...
            resolve(context, { to, classRefs, css, value }) {
              ...
              if (this.variant === "collection") {
                ...
                runtime2.forEach(classRefs, (classRef) => {
                  if (this.when)
              ...
              if (result && result.then)
                return result.then(() => runtime2.findNext(this, context));
              return runtime2.findNext(this, context);
            }
          };
          var RemoveCommand = class _RemoveCommand extends Command {
            ...
            resolve(context, { element, classRefs, css, from }) {
              ...
              if (this.variant === "element") {
                if (
                  from == null &&
                  typeof this.elementExpr.delete === "function"
                ) {
                  ...
                  if (!isDomTarget) {
                    ...
                    for (var key in lhsExprs) {
                      ...
                      lhs[key] =
                        sub && sub.evaluate ? sub.evaluate(context) : sub;
                    }
                ...
                if (from != null && Array.isArray(from)) {
                  ...
                  runtime2.implicitLoop(element, (target) => {
                    if (
                ...
                var propNames = _cssPropertyNames(css);
                runtime2.implicitLoop(from, (target) => {
          ...
          var ToggleCommand = class _ToggleCommand extends VisibilityCommand {
            ...
            static parse(parser) {
              ...
              if (parser.currentToken().type === "STYLE_REF") {
                const styleRef = parser.consumeToken();
                styleProp = styleRef.value.slice(1);
                visibility = true;
                hideShowStrategy = VisibilityCommand.resolveHideShowStrategy(
                  parser,
                  styleProp,
                );
              ...
              if (toggleExpr && !betweenValues)
                parser.raiseError(
                  "toggle <expression> requires 'between' with values",
                );
              var time = null;
              var evt = null;
              var from = null;
            ...
            toggle(context, on, classRef, classRef2, classRefs, betweenValues) {
              if (this.betweenValues) {
                if (this.visibility)
                  context.meta.runtime.implicitLoop(on, (target) => {
                    var current2 =
                      target.style[this.styleProp] ||
                      getComputedStyle(target)[this.styleProp];
                    var idx2 = betweenValues.findIndex((v) => v == current2);
                    target.style[this.styleProp] =
                      betweenValues[(idx2 + 1) % betweenValues.length];
                  });
                else {
                  ...
                  for (var key in this.toggleExpr.lhs) {
                    ...
                    lhsValues[key] =
                      val && val.evaluate ? val.evaluate(context) : val;
                  }
              ...
              if (this.visibility)
                ...
                context.meta.runtime.implicitLoop(on, (target) => {
                  if (
                    target.hasAttribute(this.attributeRef.name) &&
                    target.getAttribute(this.attributeRef.name) ===
                    ...
                    if (target.hasAttribute(this.attributeRef2.name))
                      target.removeAttribute(this.attributeRef2.name);
                    target.setAttribute(
          ...
          var HideCommand = class _HideCommand extends VisibilityCommand {
            ...
            static parse(parser) {
              ...
              if (parser.matchToken("when"))
                var when = parser.requireElement("expression");
              var hideShowStrategy = VisibilityCommand.resolveHideShowStrategy(
                parser,
                name,
              );
            ...
            resolve(ctx, { target }) {
              ...
              if (this.when) {
                var result = runtime2.implicitLoopWhen(
                  ...
                  ctx,
                  (elt) => {
                    this.hideShowStrategy("hide", elt, null, runtime2);
                  },
                  (elt) => {
                    this.hideShowStrategy("show", elt, null, runtime2);
                  },
                );
                if (result && result.then)
                  return result.then(() => runtime2.findNext(this, ctx));
              } else
                runtime2.implicitLoop(target, (elt) => {
                  this.hideShowStrategy("hide", elt, null, runtime2);
                });
          ...
          var ShowCommand = class _ShowCommand extends VisibilityCommand {
            ...
            static parse(parser) {
              ...
              if (parser.matchOpToken(":")) {
                var tokenArr = parser.consumeUntilWhitespace();
                parser.matchTokenType("WHITESPACE");
                arg = tokenArr.map((t) => t.value).join("");
              }
              if (parser.matchToken("when"))
                var when = parser.requireElement("expression");
              var hideShowStrategy = VisibilityCommand.resolveHideShowStrategy(
            ...
            resolve(ctx, { target }) {
              ...
              if (this.when) {
                var result = runtime2.implicitLoopWhen(
                  ...
                  ctx,
                  (elt) => {
                    this.hideShowStrategy("show", elt, this.arg, runtime2);
                  },
                  (elt) => {
                    this.hideShowStrategy("hide", elt, null, runtime2);
                  },
          ...
          var TakeCommand = class _TakeCommand extends Command {
            ...
            static parse(parser) {
              if (parser.matchToken("take")) {
                ...
                const weAreTakingClasses = classRefs.length > 0;
                ...
                if (parser.matchToken("from")) {
                  ...
                  if (parser.matchToken("giving")) {
                    if (weAreTakingClasses) {
                      if (replacementClass)
                        parser.raiseError(
                          "`giving` cannot be combined with `with`",
                        );
                      if (classRefs.length > 1)
                        parser.raiseError(
            ...
            resolve(context, { classRefs, from, forElt, replacementValue }) {
              if (this.variant === "class") {
                ...
                var replacementClass = this.replacementClass
                ...
                context.meta.runtime.implicitLoop(classRefs, (classRef) => {
                  ...
                  if (from)
                    context.meta.runtime.implicitLoop(from, (target) => {
                      ...
                      if (replacementClass)
                        target.classList.add(replacementClass);
                    });
                  else
                  ...
                  context.meta.runtime.implicitLoop(forElt, (target) => {
                    ...
                    if (replacementClass)
                      target.classList.remove(replacementClass);
                  });
                });
              } else {
          ...
          var MeasureCommand = class _MeasureCommand extends Command {
            ...
            static parse(parser) {
              ...
              if (parser.commandBoundary(parser.currentToken()))
                ...
                if (
                  expr.type === "symbol" &&
                  MEASURE_PROPS.includes(expr.name)
                ) {
                  targetExpr = parser.parseElement("implicitMeTarget");
              ...
              while (parser.matchOpToken(","))
                propsToMeasure.push(
                  parser.requireTokenType("IDENTIFIER").value,
                );
          ...
          var EmptyCommand = class _EmptyCommand extends Command {
            ...
            static parse(parser) {
              if (!parser.matchToken("empty") && !parser.matchToken("clear"))
                return;
              var target = null;
              if (!parser.commandBoundary(parser.currentToken()))
                target = parser.requireElement("expression");
            ...
            resolve(ctx, { target }) {
              ...
              if (Array.isArray(elt)) {
                ...
                ctx.meta.runtime.implicitLoop(elt, (e) => {
                  var tag = e.tagName;
                  if (tag === "INPUT") {
                    ...
                    e.querySelectorAll("input, textarea, select").forEach(
                      (inp) => {
          ...
          var SpeakCommand = class _SpeakCommand extends Command {
            ...
            resolve(ctx, { text, voice, rate, pitch, volume }) {
              ...
              return new Promise((resolve) => {
                utterance.onend = () => {
                  resolve(ctx.meta.runtime.findNext(this, ctx));
                };
          ...
          var SettleCommand = class _SettleCommand extends Command {
            ...
            resolve(context, { on }) {
              ...
              return Promise.all(elements.map(_settleOne)).then(() =>
          ...
          var TransitionCommand = class _TransitionCommand extends Command {
            ...
            static parse(parser) {
              ...
              do {
                ...
                from.push(
                  parser.matchToken("from")
                    ? parser.requireElement("expression")
                    : null,
                );
                parser.requireToken("to");
                to.push(
                  parser.matchToken("initial")
                    ? "initial"
                    : parser.requireElement("expression"),
                );
              } while (
            ...
            resolve(context, { from, to, using, over }) {
              ...
              var promises = [];
              runtime2.implicitLoop(target, (target2) => {
                promises.push(
                  new Promise((resolve) => {
                    ...
                    if (!internalData.transitionInitials)
                      internalData.transitionInitials = {};
                    var initialValues = internalData.transitionInitials;
                    for (var j = 0; j < this.propExprs.length; j++)
                      if (!(j in initialValues))
                        initialValues[j] = this.propExprs[j].evaluate(context);
                    for (var j = 0; j < this.propExprs.length; j++)
                      if (from[j] != null) {
                        var lhs = {};
                        for (var key in this.propExprs[j].lhs) {
                          var e = this.propExprs[j].lhs[key];
                          lhs[key] = e && e.evaluate ? e.evaluate(context) : e;
                        }
                        this.propExprs[j].set(context, lhs, from[j]);
                      }
                    var transitionStarted = false;
                    var resolved = false;
                    ...
                    setTimeout(() => {
                      for (var j2 = 0; j2 < this.propExprs.length; j2++) {
                        var lhs2 = {};
                        for (var key2 in this.propExprs[j2].lhs) {
                          var e2 = this.propExprs[j2].lhs[key2];
                          lhs2[key2] =
                            e2 && e2.evaluate ? e2.evaluate(context) : e2;
                        }
                        var val =
                          to[j2] === "initial" ? initialValues[j2] : to[j2];
                        this.propExprs[j2].set(context, lhs2, val);
                      }
                    }, 0);
                  }),
                );
              });
              return Promise.all(promises).then(() => this.findNext(context));
            }
          };
          ...
          var ViewTransitionCommand = class _ViewTransitionCommand extends Command {
            ...
            resolve(context, { type }) {
              ...
              var bodyDone;
              var bodyPromise = new Promise((r) => {
                bodyDone = r;
              });
              var options = () => bodyPromise;
              if (type)
                options = {
                  update: () => bodyPromise,
                  types: [type],
          ...
          var OnFeature = class _OnFeature extends Feature {
            ...
            execute(ctx) {
              ...
              const eventQueueInfo = ctx.meta.runtime.getEventQueueFor(
                ctx.me,
                this,
              );
              if (eventQueueInfo.executing && every === false) {
                if (
                  queueNone ||
                  (queueFirst && eventQueueInfo.queue.length > 0)
                )
                  return;
            ...
            install(elt, source, args, runtime2) {
              ...
              for (const eventSpec of onFeature.events) {
                var targets;
                if (eventSpec.elsewhere) targets = [document];
                else if (eventSpec.from)
                  targets = eventSpec.from.evaluate(
                    runtime2.makeContext(elt, onFeature, elt, null),
                  );
                else targets = [elt];
                var internalData = runtime2.getInternalData(elt);
                if (!internalData.eventState)
                  internalData.eventState = /* @__PURE__ */ new Map();
                if (!internalData.eventState.has(eventSpec))
                  internalData.eventState.set(eventSpec, {
                    execCount: 0,
                    debounced: void 0,
                    lastExec: void 0,
                  });
                var eventState = internalData.eventState.get(eventSpec);
                runtime2.implicitLoop(targets, (target) => {
                  ...
                  addEventListener.call(
                    ...
                    (handler = function listener(evt) {
                      ...
                      for (const arg of eventSpec.args) {
                        const eventValue = ctx.event[arg.value];
                      ...
                      if (eventSpec.debounceTime) {
                        ...
                        eventState.debounced = setTimeout(() => {
                      ...
                      if (eventSpec.throttleTime) {
                        if (
                          eventState.lastExec &&
                          Date.now() <
                            eventState.lastExec + eventSpec.throttleTime
                        )
                          return;
            ...
            static parse(parser) {
              ...
              var { errorHandler, errorSymbol, finallyHandler } =
                Feature.parseErrorAndFinally(parser);
              var onFeature = new _OnFeature(
                displayName,
                events,
                start,
                every,
          ...
          var DefFeature = class _DefFeature extends Feature {
            ...
            constructor(
              ...
              super();
              this.displayName =
                funcName + "(" + args.map((arg) => arg.value).join(", ") + ")";
              this.name = funcName;
              this.args = args;
              this.start = start;
              this.errorHandler = errorHandler;
            ...
            install(target, source, funcArgs, runtime2) {
              ...
              var func = function () {
                ...
                var resolve, reject;
                var promise = new Promise((theResolve, theReject) => {
                  resolve = theResolve;
                  reject = theReject;
                });
                start.execute(ctx);
            ...
            static parse(parser) {
              ...
              var { errorHandler, errorSymbol, finallyHandler } =
                Feature.parseErrorAndFinally(parser);
              var functionFeature = new _DefFeature(
                funcName,
                nameSpace,
                nameVal,
                args,
          ...
          var SetFeature = class _SetFeature extends Feature {
            ...
            install(target, source, args, runtime2) {
              this.start &&
                this.start.execute(
                  runtime2.makeContext(target, this, target, null),
                );
            }
            static parse(parser) {
              const setCmd = parser.parseElement("setCommand");
              if (setCmd) {
                ...
                const setFeature = new _SetFeature(setCmd);
          ...
          var BehaviorFeature = class _BehaviorFeature extends Feature {
            ...
            install(target, source, args, runtime2) {
              ...
              runtime2.assignToNamespace(
                ...
                nameSpace,
                name,
                (target2, source2, innerArgs) => {
                  var internalData = runtime2.getInternalData(target2);
                  var scopeName = path + "Scope";
                  var elementScope =
                    internalData[scopeName] || (internalData[scopeName] = {});
          ...
          var InstallFeature = class _InstallFeature extends Feature {
            ...
            install(target, source, installArgs, runtime2) {
              ...
              var behaviorArgs = this.behaviorArgs
                ? this.behaviorArgs.evaluate(ctx)
                : null;
              ...
              for (var i = 0; i < this.behaviorNamespace.length; i++) {
                ...
                if (
                  ...
                  throw new Error(
                    "No such behavior defined as " + this.behaviorPath,
                  );
              }
          ...
          var BindFeature = class _BindFeature extends Feature {
            ...
            install(target, source, args, runtime2) {
              queueMicrotask(() => {
                try {
                  _bind(this.left, this.right, target, this, runtime2);
                } catch (e) {
          ...
          function initLiveTemplates(
            ...
            runtime2.addBeforeProcessHook((elt) => {
              if (!elt || !elt.querySelectorAll) return;
              elt.querySelectorAll(LIVE_SELECTOR).forEach((tmpl) => {
                if (processed.has(tmpl)) return;
                processed.add(tmpl);
                var source = getTemplateSource(tmpl);
                var script =
                  tmpl.getAttribute("_") ||
                  tmpl.getAttribute("data-script") ||
                  "";
              ...
              while (i < raw.length) {
                ...
                try {
                  ...
                  if (exprParser.matchToken("if")) {
                    ...
                    var elseNode = exprParser.matchToken("else")
                      ? exprParser.requireElement("expression")
                      : null;
                    parts.push({
                      type: "conditional",
                      valueNode,
              ...
              if (vals.some((v) => v && v.then))
                return Promise.all(vals).then((resolved) => {
                  ctx.meta.__ht_template_result.push(
                    resolved
                      .map((val, i) => _stringifyTemplatePart(val, parts[i]))
                      .join(""),
                  );
                  return this.findNext(ctx);
                });
          ...
          var RenderCommand = class _RenderCommand extends Command {
            ...
            resolve(ctx, { template, templateArgs, target }) {
              if (!(template instanceof Element))
                throw new Error(
                  this.template_.sourceFor() + " is not an element",
                );
              var buf = [];
              var runtime2 = ctx.meta.runtime;
              ...
              try {
                ...
                console.error(
                  ...
                  e.parseError?.message || e.message || e,
                );
                ctx.result = "";
                return runtime2.findNext(this, ctx);
              }
          ...
          function evaluate(src, ctx, args) {
            ...
            ctx = Object.assign(
              runtime.makeContext(body, null, body, null),
              ctx || {},
            );
            const element = kernel.parse(tokenizer, src);
            ...
            if (element.execute) {
              element.execute(ctx);
              return ctx.meta.returnValue !== void 0
                ? ctx.meta.returnValue
                : ctx.result;
          ...
          function mergeMetaConfig() {
            const element = document.querySelector('meta[name="htmx-config"]');
            if (element) {
              const metaConfig = JSON.parse(element.content);
          ...
          if (typeof document !== "undefined")
            (async () => {
              mergeMetaConfig();
              const scriptNodes = globalScope.document.querySelectorAll(
